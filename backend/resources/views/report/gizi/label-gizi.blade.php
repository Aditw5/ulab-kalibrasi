        ...
        <tbody>
            <tr>
                <td style="padding: 5px;">
                    <span style="font-size: 13pt;text-align: center" color="#000000">
                        <b>RSD Gunung Jati</b></span>
                    {{-- <span style="font-size: 10pt;" color="#000000">Jl. Kesambi No.56, Kesambi, Kec. Kesambi, Kota
                        Cirebon, Jawa Barat 45134
                        </span> --}}
                    <hr style="margin-top: 4px;margin-bottom:0px; border-style:dashed" />
                    <hr style="margin-top: 2px; border-style:dashed" />
                    <span style="font-size: 10pt;font-width:bold" color="#000000">Nama : Rizqi Dimas Setiawan</span>
                </td>
            </tr>
            {{-- <hr style="border-top-style:dashed;border-bottom:none"/> --}}
