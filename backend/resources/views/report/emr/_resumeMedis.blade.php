...
<body>
    ...
    <div style="display: block;position:relative;top:-1.8rem">
        ...
        <table width="100%" style="border: 1px solid black">
            <tr>
                <td width="25%" class="label-top" style="display:inline;white-space: normal; word-wrap: break-word;">
                ...
                <td style="display: inline !important;white-space: normal;">
                    <table width="100%">
                        <tr>
                            <td class="label-top" style="display: inline !important;white-space: normal; word-wrap: break-word;">
                                <pre class="styled-pre label-top">{{ $data['pemeriksaPenunjang'] }}</pre>
                            </td>
                        </tr>
                    </table>
                </td>
                            ...
                            <td class="label-top" width="70%">
                                @php
                                    ...
                                    foreach ($data['diagnosaDokter'] as $item) {
                                        ...
                                        if (isset($item['norecDiagnosa']) && $item['norecDiagnosa'] != '') {
                                            $diagnosaDokter[] = $item['ketDiagnosaDok'];
                                            if ($item['jenisDiagnosa']['label'] == 'Primary / utama') {
                                                // dd($item['diagnosaIcd10']);
                            ...
                            <td class="label-top" width="70%">
                                @php
                                    ...
                                    foreach ($data['detailTindakan'] as $item) {
                                        if (isset($item['norecDiagnosa9']) && $item['norecDiagnosa9'] != '') {
        ...
        <table width="100%">
            <tr>
                ...
                <td class="label-top">
                    <span
                        class="normal medium block">{{ $identitas['tglkontrol'] }}</span>
