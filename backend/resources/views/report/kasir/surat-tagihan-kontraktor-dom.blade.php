...
<head>
    ...
    <title>Surat Tagihan Kontraktor</title>
</head>
<style>
    @page {
        margin: 0
...
<body style="padding:25px">
    ...
    <table width="100%" style="margin-top: -19px;">
                        ...
                        <tr>
                            <td>
                                <table width="100%"  style="font-size: 15px;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td align="left" style="max-width: 330px;">Yth. Pimpinan</td>
                                    </tr>
                                    <tr>
                                        <td align="left" style="max-width: 330px;">{{ $res['identitas']->namarekanan }}</td>
                                    </tr>
                                    <tr>
                                        <td align="left" style="max-width: 330px;">
                                            <span style="display: inline-block; word-wrap: break-word; max-width: 100%;"> di {{ $res['alamatBaru'] && $res['alamatBaru'] != '-' ? $res['alamatBaru'] : $res['identitas']->alamatlengkap }}</span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
        ...
        <tbody>
            <tr>
                <td>
                    <table width="100%" cellspacing="0" cellpadding="0" style="border-bottom:2px solid black;margin-top: -8px;">
                        <thead style="display: none"></thead>
                        <tbody>
                            <tr>
                                <td class="text-center">
                            ...
                            <tr>
                                <td width="15%">
                                    <span class="text-normal"> Mohon dengan hormat agar rincian hutang di bawah ini dapat diselesaikan dengan segera
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" style="border-bottom:2px solid black;">
                        ...
                        <tbody>
                            ...
                            <tr style="font-size: 11pt;">
                                ...
                                <td width="50%">
                                    <span class="text-normal">:
                                        {{ $res['identitas']->alamat_pasien}}, {{ $res['identitas']->namakecamatan}}, {{ $res['identitas']->namakotakabupaten}}</span>
                                </td>
                            </tr>
                            <tr style="font-size: 11pt;">
                                <td width="15%">
                                ...
                                <td width="35%">
                                    <span class="text-normal">:
                                        {{ date_format(date_create($res['identitas']->tglregistrasi), 'd/m/Y H:i') }} - {{ date_format(date_create($res['identitas']->tglpulang), 'd/m/Y H:i') }}</span>
                                </td>
                            </tr>
            </tr>
        </tbody>
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            <tr>
                <td class="text-center">
                    <span class="text-judul" style="font-size: 11pt">PERINCIAN BIAYA PERAWATAN</span>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" style="border-top:2px solid black;">
        ...
        <tbody style="font-size: 11pt;">
            ...
            <tr>
                <td width="20%" class="text-left">
                    <span class="text-biasa">DIBAYAR PASIEN</span>
                </td>
                <td class="text-center">
                    <span class="text-biasa">:</span>
                </td>
            ...
            <tr style="background: #d6d4d4;">
                <td width="20%" class="text-left">
                    <span class="text-biasa">{{$res['identitas']->kelompokpasien == 'Umum'  ? 'PIUTANG' : 'JUMLAH TAGIHAN KONTRAKTOR'}}</span>
                </td>
                <td class="text-center">
                    <span class="text-biasa">:</span>
                </td>
            ...
            <tr>
                <td width="20%" class="text-left">
                    <span class="text-biasa">DIBAYAR BPJS</span>
                </td>
                <td class="text-center">
                    <span class="text-biasa">:</span>
                </td>
                ...
                <td class="text-right">
                    <span class="text-biasa bold">
                        {{ number_format(($res['total'] - $res['totalklaimiur']), 0, '.', ',') }}</span>
                </td>
                @elseif ($res['iurbayar'] == 0)
                <td class="text-right">
                    <span class="text-biasa bold">
                        {{ number_format(($res['total'] - $res['klaim']), 0, '.', ',') }}</span>
                </td>
                @endif
            </tr>
            <tr>
                <td width="20%" class="text-left">
                    <span class="text-biasa">DIBAYAR KONTRAKTOR</span>
                </td>
                <td class="text-center">
                    <span class="text-biasa">:</span>
                </td>
                <td class="text-right">
                    <span class="text-biasa bold">
                        {{ number_format($res['sudahBayar'], 0, '.', ',') }}</span>
                </td>
            </tr>
            <tr>
                <td width="20%" class="text-left">
            ...
            <tr>
                <td>
                    <span class="text-biasa"><i>#
                            {{ strtoupper(App\Traits\Valet::static_terbilang($res['klaim'])) }}
                            #</i>
                </td>
            </tr>
        </tbody>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="1">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><span class="text-biasa">{{ number_format($item->totalppenjamin, 0, '.', ',') }}</span>
                            </td>
                        </tr>
                        @endforeach
                        <tr>
        ...
        <tbody style="font-size: 11pt">
            <tr>
                ...
                <td width="50%" class="text-center">
                    <span class="text-biasa">{!! $profile->namakota !!}, {{\Carbon\Carbon::parse(date('Y-m-d H:i'))->isoFormat('DD MMMM Y')}}</span>
                </td>
            </tr>
            <tr>
                <td width="50%">
                ...
                <td width="50%" class="text-center">
                    <span class="text-biasa">An. Direktur Wadir Umum dan Keuangan</span><br>
            ...
            <tr>
                ...
                <td height="10" valign="bottom" height="100" width="15%" class="text-center" style="border-bottom:2px solid black;">
