            ...
            <tbody>
                <tr>
                    <td style="padding: 30px;text-align: left">
                        <font style="font-size: 12pt;" color="#000000" face="Tahoma">
                            <b>{{ $dataReport['namaprofile'] }}</b></font><br>
                        <font style="font-size: 10pt;" color="#000000" face="Tahoma">{{ $dataReport['alamat'] }}</font>
                        <br>
                        <hr style="margin-top: 6px;" />
                        <font style="font-size: 12pt;" color="#000000" face="Tahoma"><b>No Antrian :
                                {{ $dataReport['noantrian'] }}</b></font><br />
                        <hr />
