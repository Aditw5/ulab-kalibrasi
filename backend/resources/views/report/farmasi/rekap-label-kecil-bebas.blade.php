                ...
                <tr>
                    <table width="100%">
                        <tr>
                            ...
                            <td width="20%">
                                <span
                                    style="font-size: 11pt;font-weight: bold">{{ date('Y-m-d h:m:s', strtotime($racikan[0]->tglresep ?? '')) }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td width="8%">
                        ...
                        <tr>
                            ...
                            <td width="20%">
                                <span style="font-size: 11pt;font-weight: bold">
                                    {{ \Carbon\Carbon::parse($nonRacikan[0]->tgllahir)->format('d-m-Y') ?? '' }}
                                </span>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td style="font-weight:bold;text-align:center" width="20%">
                                <span style="font-size: 11.5pt;font-weight:bold">{{ $racikan[0]->aturanpakai ?? '-' }}
                                </span>
                            </td>
                            <td style="font-weight:bold;text-align:center" width="10%">
                                <span
                                    style="font-size: 11pt;font-weight:bold">{{ $racikan[0]->satuan ?? '-' }}</span>
                            </td>
                        </tr>
                    </table>
                </tr>
                    ...
                    <table width="100%">
                        <tr>
                            <th colspan="2" style="text-align:center">
                                <span style="font-size: 11pt">{{ $racikan[0]->satuanresep ?? '-' }}</span>
                            </th>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align:center">
                                <span style="font-size: 11pt">{{ $racikan[0]->keteranganpakai ?? '-' }}</span>
                            </td>
                        </tr>
                    </table>
                </tr>
                    ...
                    <tbody>
                        <tr>
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width="20%">
                                        <span
                                            style="font-size: 12pt;font-weight: bold">{{ date('Y-m-d h:m:s', strtotime($nonRacikan[0]->tglstruk ?? '')) }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="8%">
                        ...
                        <tr>
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:bold;text-align:center" width="5%">
                                        <span style="font-size: 12pt;font-weight:bold">{{ $d->qty }}</span>
                                    </td>
                                    <td style="font-weight:bold;text-align:center" width="10%">
                                        <span
                        ...
                        <tr>
                            <table width="100%">
                                ...
                                <tr>
                                    <td style="font-weight:bold;text-align:center" width="20%">
                                        <span
                                            style="font-size: 17pt;font-weight:bold">{{ $d->aturanpakai ?? '' }} {{$d->keteranganpakai != null ? '('. $d->keteranganpakai .')' : ''}}
                                        </span>
                                    </td>

                                    <td style="font-weight:bold;text-align:center" width="10%">
                                        <span
                                            style="font-size: 12pt;font-weight:bold">{{ $d->satuan ?? '-' }}</span>
                                    </td>
                                </tr>
                            </table>
                        </tr>
                        {{-- <tr>
                            <table width="100%">
                                <tr>
                                    <th colspan="2" style="text-align:center">
                                        <span style="font-size: 12pt;">{{ $d->satuanresep ?? '-' }}</span>
                                    </th>
                                </tr>
