<template>
  ...
  <div class="company-header is-dark-card-bordered is-dark-bg-6" style="padding: 10px 10px !important; margin-top: -10px !important">
      <div class="header-item is-dark-bordered-12">
        <div class="item-inner is-flex">
          ...
          <div v-if="pasien.nocm != undefined">
              <div class="current-user" style="display: flex; margin-left: 10px; align-items: center;">
                  <div>
                      ...
                      <!-- <VAvatarIcon :max-height="5" class="avatar-wrapper is-warning" :picture="pasien.jeniskelamin!=undefined && pasien.jeniskelamin.toUpperCase() ==
                          'PEREMPUAN' ? '/images/avatars/svg/vuero-4.svg' : '/images/avatars/svg/vuero-1.svg'" squared
                          :badge="(pasien.jeniskelamin.toUpperCase() == 'PEREMPUAN' ? 'fas fa-venus' : 'fas fa-mars')" v-if="!pasien.isfoto" /> -->
                  </div>
                  <div style="margin-left: 10px; color: white;">
                      <span class="block-text" style="font-size: 14pt;"><b>{{ pasien.namapasien }}</b> | <VTag color="primary" :label="pasien.umur" style="background-color: #116863;" /> | {{ pasien.nocm }} | {{ pasien.nohp }}</span>
      ...
      <!-- <div class="header-item is-dark-bordered-12">
        <div class="item-inner px-4" style="color: white">
          ...
          <span class="block-text" style="font-size: 11pt;">{{ selectedRegistrasi.namaruangan }} | <VTag color="info" :label="selectedRegistrasi.namakelas" style="background-color: #116863;" /> | No. Registrasi : {{ selectedRegistrasi.noregistrasi }} | {{ selectedRegistrasi.kelompokpasien }} {{selectedRegistrasi.kelompokpasien == 'BPJS' || selectedRegistrasi.kelompokpasien == 'BPJS Non PBI ' ? ` / ${selectedRegistrasi.nosep}`: '' }}</span>
      ...
      <div class="header-item is-dark-bordered-12">
        <div class="item-inner">
          <div class="is-flex px-4">
            ...
            <VCard class="rounded-pad mr-2" style="background-color: #B8F2E6;" v-tooltip.bubble="'Jumlah Pasien'" @click="rajalSemua">
          ...
          <!-- <span class="is-flex px-4 mt-2">
            ...
            <VButton v-if="(selectedRegistrasi.kelompokpasien == 'BPJS' || selectedRegistrasi.kelompokpasien == 'BPJS Non PBI ') && selectedRegistrasi.inacbg_totalgrouper > 0 && selectedRegistrasi.inacbg_totalgrouper - selectedRegistrasi.billing < 0" style="padding:10px" rounded outlined color="danger" class="is-pulled-right ml-2"  v-tooltip-prime.top="'Selisih'" icon="fas fa-arrow-alt-circle-down" raised bold>
                {{ selectedRegistrasi.inacbg_totalgrouper ? H.formatRp(selectedRegistrasi.inacbg_totalgrouper - selectedRegistrasi.billing, 'Rp. ') : 'Rp.0' }}
            </VButton>
          </span> -->
        </div>
