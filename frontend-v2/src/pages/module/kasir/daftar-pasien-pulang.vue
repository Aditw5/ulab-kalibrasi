...
<template>
  <VCard>
    <div class="columns column">
      <h3 class="title is-5 mb-2 mr-1">Daftar Pasien Pulang </h3>
    </div>
                ...
                <div class="foot-block">
                  ...
                  <div class="developers">
                    <VButton type="button" icon="fas fa-notes-medical" class="is-fullwidth mr-3" color="warning" outlined
                      ...
                      Verifikasi </VButton>
                    <VButton type="button" icon="feather:edit" class="is-fullwidth mr-3" color="info" outlined raised :to="{
                      name: 'module-kasir-billing',
                      query: {
                        norec_pasien_daftar: items.norec_pd,
                      },
                    }">
                      Detail Tagihan </VButton>
          ...
          <div class="columns is-multiline">
            ...
            <div class="column is-12">
              <VField class="is-autocomplete-select" v-slot="{ id }">
                ...
                <VControl icon="feather:search">
                  <Multiselect mode="single" v-model="item.qkelompokpasien" :options="listKelompokPasien"
...
async function fetchPasien() {
  ...
  const response = await useApi().get(
    ...
    }&tglAkhir=${moment(item.value.periode.end).format('YYYY-MM-DD')}&offset=${offset}&limit=${limit}&rows=${currentPage.value.rows}${namaPasien}`)
