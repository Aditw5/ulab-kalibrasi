...
<template>
        ...
        <div class="search-widget">
          <div class="field">
            <div class="columns is-multiline">
              ...
              <div class="field column is-9 pt-2 pb-0 mt-5">
                <div class="control">
                  <div class="columns is-multiline">
                      ...
                      <div class="content-wrap">
                        <div class="content-box">
                          ...
                          <div class="column">
                            ...
                            <div class="columns is-multiline">
                              <div class="column is-6 pt-0 pb-0 ">
                                <span>NO CM/NO REGIS/NO KK :</span> <span style="font-weight: 500;color: #646161;">
                                {{ data.nocm }} / {{data.noregistrasi}} / {{data.noidentitas}}
                              </span>
                              </div>
                              <div class="column is-6 pt-0 pb-0">
  ...
  <Dialog v-model:visible="modalUpdateDokter" modal header="Form Verif SITB" :style="{ width: '65vw' }">
    <div class="column">
      <span style="font-weight: 500;">Nomor SITB </span>
      <VField>
...
const fetchOrder = async () => {
  ...
  await useApi().get(`registrasi/get-order-sitb?${ruangan}&limit=${limit}&offset=${offset}`).then((response) => {
...
const simpanVerify = async () => {
  // console.log(item)
  if(item.value.nositb == "" || item.value.nositb == undefined || item.value.nositb == null){
    H.alert('error', 'Nomor SITB tidak boleh kosong')
    return
  }
  const objSave = {
    nositb: item.value.nositb,
  ...
  await useApi().post('registrasi/get-save-sitb-order', objSave).then((response: any) => {
    fetchOrder()
...
const fetchRuangan = async (filter: any) => {
  ...
  // })
  const response = await useApi().get(`/registrasi/get-ruangan`)
  d_Ruangan.value = response.map((e: any) => { return { label: e.namaruangan, value: e.id, default: e } })
  d_Ruangan.value.forEach((element) => {
