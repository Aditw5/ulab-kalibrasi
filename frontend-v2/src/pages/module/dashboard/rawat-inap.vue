<template>
  <section>
                ...
                <div class="column is-12">
                  ...
                  <div class="live-match">
                    <div class="head">
                      ...
                      <!-- <div class="league">
                      <div class="right" style="margin-top : -4.5rem; margin-left : 12rem;">
                        <div @click="showModalFilter()" class="live-block is-clickable">
                          <span>{{ H.formatDate(item.filterTgl, 'D MMM YYYY') }}<i class="fas fa-filter ml-3"
                    ...
                    <div class="match">
                      ...
                      <div class="center">
                        ...
                        <span class="score">{{ dataPasien.length }}</span>
                      </div>
                      <div class="right">
            ...
            <VCard>
              ...
              <div class="columns is-multiline">
                <div class="column is-6">
                  <CardCountRev icon="/images/simrs/icon-antrian.png" straight :total="item.totalPasien" label="Pasien" />
                </div>
                <div class="column is-6">
                  ...
                  <div v-for="item in dataDokter" :key="item.id" class="column is-12">
                    <div class="tile-grid-item" @click="detailDokter(item)">
                      <div class="tile-grid-item-inner">
                        ...
                        <VAvatar size="small" picture="/images/avatars/svg/user2.svg" color="primary" squared bordered />
                ...
                <TabView class="tabview-custom " :scrollable="true" @tab-click="klikTab($event)">
                              ...
                              <div class="list-view-item-inner">
                                ...
                                <div class="meta-left">
                                  ...
                                  <h3>
                                    ...
                                    {{ item.namakelas }}
                                    <span v-if="item.catatan != null && parseInt(item.selisihwaktu.split(' ')[0]) >= 2">|</span>
                                    <VTag v-if="item.catatan != null && parseInt(item.selisihwaktu.split(' ')[0]) >= 2"
                                      class="mt-3 ml-2" label="Rencana BPJS"
                                      :color="item.catatan == 'rencana-bpjs' ? 'green' : 'orange'" rounded />
                                  ...
                                  <span style="font-weight: bold;">Dokter Pemeriksa :
                                    <i aria-hidden="true" class="iconify"></i>
                                    <span>{{ item.nama }}</span>
                                    <span v-for="data in item.dokterTambahan">, {{data.namalengkap}}</span>
                                  </span>
                                  <!-- <span>
                                  ...
                                  <div>
                                    ...
                                    <VTag :label="item.selisihwaktu" :color="'warning'" class="mr-2 mt-3-min"
                                      ...
                                      <i v-if="item.tandaigd" aria-hidden="true" class="fas fa-ambulance"></i>
                                    <VTag v-if="item.iskanker == true" label="Pasien Kanker" :color="'danger'" class="mr-2 mt-3-min"/>
                                    <VTag
                                      :label="item.jenissuratfk === null ? 'Belum Dibuat SKDP' : 'Sudah Ada SKDP'"
                                      :color="item.jenissuratfk === null ? 'warning' : 'success'"
                                      class="mr-2" />
                                  ...
                                  <VDropdown icon="feather:more-vertical" spaced right
                                    ...
                                    <template #content>
                                      <a role="menuitem" @click="openModalDpjp(item)" class="dropdown-item is-media">
                                        ...
                                        <div class="meta">
                                          <span>Ubah DPJP dan Tambah Dokter Pemeriksa</span>
                                        </div>
                                      </a>
                                      <a role="menuitem" @click="openModalDelegasiDpjp(item)" class="dropdown-item is-media">
                                        <div class="icon">
                                          <i class="fas fa-user-plus" aria-hidden="true"></i>
                                        </div>
                                        <div class="meta">
                                          <span>Delegasi DPJP</span>
                                        </div>
                                      </a>
                                      ...
                                      <a role="menuitem" @click="RequestSITB(item)" class="dropdown-item is-media" v-if="!item.sitb_id">
                                        <div class="icon">
                                          <i class="fas fa-file" aria-hidden="true"></i>
                                        </div>
                                        <div class="meta">
                                          {{item.sitb}}
                                          <span>Request SITB</span>
                                        </div>
                                      </a>
                                      <a role="menuitem" @click="InputSitb(item)" class="dropdown-item is-media">
                                        <div class="icon">
                                          <i class="fas fa-file" aria-hidden="true"></i>
                                        </div>
                                        <div class="meta">
                                          <span>Input SITB</span>
                                        </div>
                                      </a>
                                      ...
                                      <a role="menuitem" @click="!item.tandaigd ? tandaPasienIGD(item) : batalTandaPasienIGD(item)" class="dropdown-item is-media">
                                        <div class="icon">
                                          <i class="fas fa-ambulance" aria-hidden="true"></i>
                                        </div>
                                        <div class="meta">
                                          <span>{{!item.tandaigd ? 'Tandai' : 'Batal Tandai'}}</span>
                                        </div>
                                      </a>
                                      ...
                                      <a role="menuitem" href="#" class="dropdown-item is-media" @click="cetakSEP(item)">
                                        <div class="icon">
                                          <i class="fas fa-print" aria-hidden="true"></i>
                                        </div>
                                        <div class="meta">
                                      ...
                                      <a role="menuitem" @click="cetakLembarKeluar(item)" class="dropdown-item is-media">
                                        <div class="icon">
                                          <i class="fas fa-print" aria-hidden="true"></i>
                                        </div>
                                        <div class="meta">
                                      ...
                                      <a v-if="item.norec_pd != null" @click="kirimWASuratKeteranganDokter(item)"
                                        role="menuitem" class="dropdown-item is-media">
                                        <div class="icon">
                                          <i class="lnir lnir-whatsapp" aria-hidden="true"></i>
                                        </div>
                                        <div class="meta">
                                          <span>Kirim WA Surat Dokter</span>
                                        </div>
                                      </a>
                                      <a v-if="item.iskanker == null || item.iskanker == false" @click="openModalAccKanker(item)"
                                        role="menuitem" class="dropdown-item is-media">
                                        <div class="icon">
                                          <i class="fas fa-user-edit" aria-hidden="true"></i>
                                        </div>
                                        <div class="meta">
                                          <span>Jadikan Pasien Kanker</span>
                                        </div>
                                      </a>
                                      <a v-if="item.iskanker == true" @click="openModalAccKanker2(item)"
                                        role="menuitem" class="dropdown-item is-media">
                                        <div class="icon">
                                          <i class="fas fa-window-close" aria-hidden="true"></i>
                                        </div>
                                        <div class="meta">
                                          <span>Batalkan Pasien Kanker</span>
                                        </div>
                                      </a>
                                      <a role="menuitem" href="#" class="dropdown-item is-media"
                              ...
                              <div class="list-view-item-inner">
                                ...
                                <div class="meta-left">
                                  ...
                                  <span>
                                    ...
                                    <i aria-hidden="true" class="fas fa-circle icon-separator" v-if="item.tglmeninggal"></i>
                                    <VTag v-if="item.tglmeninggal" label="Pasien Meninggal" :color="'danger'" class="mr-2 mt-3-min"
                                      v-tooltip.bubble="'Pasien Meninggal'" />
                  ...
                  <TabPanel>
                    <template #header>
                      ...
                      <Badge :value="sourceMutasi.length" v-if="sourceMutasi.length > 0" severity="danger" class="ml-2" />
                    </template>
                    <div v-if="activeTab == 2">
                      <div class="list-view list-view-v3">
                        <div class="search-menu-ranap" style="margin-bottom : 1rem;">
                          ...
                          <VButton color="primary" raised class="search-button-ranap" @click="fetchPasienMutasi()"
                            :loading="isLoadingTT"> Cari Data </VButton>
                        </div>
    ...
    <VModal :open="modalSKDokter" title="Filter Periode" :noclose="true" size="small" actions="right"
      ...
      <template #action>
        <VButton icon="feather:" :loading="isLoading" color="primary" raised @click="saveSKDokter(item)">Simpan</VButton>
      </template>
    </VModal>
    ...
    <Dialog v-model:visible="modalChangeDokter" modal header="Form Dokter DPJP" :style="{ width: '50vw' }">
      <div class="column">
        <span style="font-weight: 500;">Dokter DPJP </span>
      ...
      <div class="column" v-for="data in listDokterTambahan">
        ...
        <VField class="is-autocomplete-select">
          <VControl icon="feather:search">
            <AutoComplete v-model="data.dokterPemeriksaTambahan" :suggestions="d_Dokter" @complete="fetchDokter($event)"
              :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'" :loadingIcon="'pi pi-spinner'"
              :field="'label'" placeholder="ketik Nama Dokter" />
          </VControl>
        </VField>
      ...
      <div class="column">
        <VButton color="info" :size="'small'" :disabled="!item.dokterPemeriksa2" icon="pi pi-plus" outlined raised @click="tambahDokter()"> Tambah Dokter </VButton>
      </div>
      <template #footer>
    ...
    <Dialog v-model:visible="modalDelegasiDokter" modal header="Form Delegasi DPJP" :style="{ width: '50vw' }">
      <div class="column">
        <span style="font-weight: 500;">Delegasi Dokter DPJP </span>
        <VField class="is-autocomplete-select">
          <VControl icon="feather:search">
            <AutoComplete v-model="item.dokterPemeriksa" :suggestions="d_Dokter" @complete="fetchDokter($event)"
              :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'" :loadingIcon="'pi pi-spinner'"
      ...
      <template #footer>
        <VButton color="danger" icon="pi pi-times" outlined raised @click="modalDelegasiDokter = false"> Batal </VButton>
        <VButton color="primary" icon="pi pi-check" raised @click="saveDelegasiDokter()" :loading="btnLoadSimpan"> Delegasi
        </VButton>
      </template>
    </Dialog>
    <Dialog v-model:visible="modalChangeTglPulang" modal header="Form Ubah Tanggal Pulang" :style="{ width: '25vw' }">
      <div class="column">
        <span style="font-weight: 500;">Tanggal Pulang</span>
          ...
          <VControl class="prime-auto ">
            <div class="is-rounded is-rounded-select">
              <Calendar v-model="item.tglpulang" selectionMode="single" :manualInput="true" class="w-100 is-rounded"
                showTime :showIcon="true" hourFormat="24" :date-format="'yy-mm-dd'" :max-date="new Date()" />
            </div>
          </VControl>
        </VField>
      </div>
      <template #footer>
        <VButton color="danger" icon="pi pi-times" outlined raised @click="modalChangeTglPulang = false"> Batal </VButton>
        <VButton color="primary" icon="pi pi-check" raised @click="saveChangeTglPulang()" :loading="btnLoadSimpan"> Update
        </VButton>
      </template>
    </Dialog>
    <Dialog v-model:visible="modalBatalPulang" modal header="Form Batal Pulang" :style="{ width: '25vw' }">
      <div class="column">
        <VField label="Ruangan" class="is-rounded-select is-autocomplete-select"
            ...
            <VControl icon="feather:list" fullwidth>
              <Multiselect mode="single" v-model="item.namaruangan" :options="d_Ruangan" placeholder="Pilih data"
                :searchable="true" :attrs="{ id }" autocomplete="off" disabled />
            </VControl>
          </VField>
      </div>
      <div class="column">
      ...
      <div class="column" v-if="item.namakelasrawat">
      ...
      <template #footer>
        <VButton color="danger" icon="pi pi-times" outlined raised @click="modalBatalPulang = false"> Batal </VButton>
        <VButton color="primary" icon="pi pi-check" raised @click="batalPulang()" :loading="btnLoadSimpan" class="ml-2"> Batal Pulang </VButton>
      </template>
    </Dialog>

    <VModal :open="modalInputSitb" title="Input No SITB" size="medium" actions="right"
      @close="modalInputSitb = false" cancelLabel="Tutup">
      <template #content>
        <div class="columns is-multiline">
          <div class="column is-12">
            <VField>
    ...
    <Dialog v-model:visible="modalAccKanker" modal header="Konfirmasi" :style="{ width: '15vw' }">
      ...
      <template #footer>
          <VButton color="danger" icon="pi pi-times" outlined raised @click="modalAccKanker = false" class="mr-3"> Batal </VButton>
          <VButton color="primary" icon="pi pi-check" raised @click="jadikanPasienKanker()" :loading="btnLoadSimpan"> Update
          </VButton>
        </template>
    </Dialog>
    ...
    <Dialog v-model:visible="modalAccKanker2" modal header="Konfirmasi" :style="{ width: '15vw' }">
      ...
      <template #footer>
          <VButton color="danger" icon="pi pi-times" outlined raised @click="modalAccKanker2 = false" class="mr-3"> Batal </VButton>
          <VButton color="primary" icon="pi pi-check" raised @click="batalkanPasienKanker()" :loading="btnLoadSimpan"> Update
          </VButton>
        </template>
    </Dialog>
    ...
    <VIconButton v-tooltip.bottom="'Surat Kematian'" label="Bottom Left" v-if="item.status == 'Meninggal'"
      ...
      <VButton type="button" icon="fas fa-clipboard-check" :disabled="selectedItem.statuspulang != 'Meninggal'" class="mr-2"
        circle outlined color="danger" raised @click="saveSuratKematian(selectedItem)">
        Surat Meninggal
      </VButton>
      <VButton type="button" icon="fas fa-file" class="mr-2"
        circle outlined color="warning" raised @click="cetakLembarKeluar(selectedItem)">
        Lembar Keluar Masuk
      </VButton>
    </OverlayPanel>
    <!-- modal uabh dokter dpjp-->
