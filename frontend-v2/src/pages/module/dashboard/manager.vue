                      ...
                      <div class="list-view list-view-v3">
                        <div class="search-menu-ranap" style="margin-bottom : 1rem;">
                          ...
                          <div class="search-location-ranap" style="width: 100% !important;">
                            ...
                            <input type="text" placeholder="Cari Nama Perusaahn, No Pendaftaran"
                              ...
                              <div class="list-view-item-inner">
                                ...
                                <div class="meta-left">
                                  ...
                                  <h3>
                                    ...
                                    {{ item.namakelas }}
                                    <span
                                      v-if="item.catatan != null && parseInt(item.selisihwaktu.split(' ')[0]) >= 2">|</span>
                                  ...
                                  <div>
                                    ...
                                    <VTag v-if="item.iskanker == true" label="Pasien Kanker" :color="'danger'"
                                      class="mr-2 mt-3-min" />
                                    <VTag :label="item.jenissuratfk === null ? 'Belum Dibuat SKDP' : 'Sudah Ada SKDP'"
                                      :color="item.jenissuratfk === null ? 'warning' : 'success'" class="mr-2" />
                                ...
                                <div class="meta-right">
                                  ...
                                  <VDropdown icon="feather:more-vertical" spaced right
                                    ...
                                    <template #content>
                                      ...
                                      <a role="menuitem" @click="openModalDelegasiDpjp(item)"
                                      ...
                                      <a role="menuitem" @click="RequestSITB(item)" class="dropdown-item is-media"
                                        v-if="!item.sitb_id">
                                        <div class="icon">
                                      ...
                                      <a role="menuitem"
                                        @click="!item.tandaigd ? tandaPasienIGD(item) : batalTandaPasienIGD(item)"
                                        class="dropdown-item is-media">
                                        <div class="icon">
                                      ...
                                      <a v-if="item.iskanker == null || item.iskanker == false"
                                        @click="openModalAccKanker(item)" role="menuitem"
                                        class="dropdown-item is-media">
                                        <div class="icon">
                                      ...
                                      <a v-if="item.iskanker == true" @click="openModalAccKanker2(item)" role="menuitem"
                                        class="dropdown-item is-media">
                                        <div class="icon">
