              ...
              <div class="column" v-else>
                ...
                <div v-else>
                  <div class="column mt-5">
                    <div class="column-12">
                      <DataTable :value="d_LaporanRadiologi" :paginator="true" :rows="5" :rowsPerPageOptions="[5, 10, 25]"
...
async function cariRiwayat() {
  ...
  useApi().get(
    `/radiologi/laporan-tindakana-radiologi?tglAwal=${startDate}&tglAkhir=${endDate}&dokterdpjp=${dokterdpjp}&dokter=${dokterPemeriksa}&kelompokpasien=${kelompokpasien}`).then((response: any) => {
