...
<template>
  ...
  <div class="column">
    <VCard>
      <h3 class="title is-5 mb-2">Laporan Indexing Rawat Gawat Darurat</h3>
...
const exportExcel = () => {
  ...
  remakeData.value = dataSource.value.map((e: any) => {
    return {
      ...
      Tanggal: e.tglmasuk, StatusPulang: e.statuspulang, TanggalPulang: e.tglpulang, KondisiPasien: e.kondisipulang, Dokter: e.dokter, RuanganAsal: e.namaruanganasal, RuanganRawat: e.namaruanganrawat, Kelas: e.namakelas, AsalRujukan: e.asalrujukan,
