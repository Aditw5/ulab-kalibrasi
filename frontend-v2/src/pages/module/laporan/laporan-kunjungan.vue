      ...
      <div class="column" v-else>
        ...
        <div v-else>
          <DataTable :value="dataSource" class="p-datatable-sm" :loading="isLoading" :paginator="true" :rows="10"
            ...
            <Column field="alamatlengkap" header="Alamat" :sortable="true" style="min-width: 50px"></Column>
            <Column field="namadesakelurahan" header="Desa" :sortable="true" style="min-width: 50px"></Column>
            <Column field="kecamatan" header="Kecamatan" :sortable="true" style="min-width: 50px"></Column>
            <Column field="namakotakabupaten" header="Kabupaten/Kota" :sortable="true" style="min-width: 50px"></Column>
            <Column field="noantrian" header="Antrian" :sortable="true" style="min-width: 50px"></Column>
            <Column field="tglmasuk" header="Tanggal" :sortable="true" style="min-width: 200px">
              <template #body="slotProps">
...
const fetchData = async () => {
  ...
  await useApi().get(`pelayanan/get-laporan-pengunjung?${tglAwal}${tglAkhir}${ruanganfk}${dokter}${nama}${kelompokpasien}${statuspasien}${departemen}`).then((response: any) => {
...
const exportExcel = () => {
  ...
  remakeData.value = dataSource.value.map((e: any) => {
    return {
      NamaPasien: maskNamaPasien(e.namapasien), NoRM: e.nocm, NoRegistrasi: e.noregistrasi, JenisKelamin: e.jeniskelamin,
