        ...
        <div class="column is-12">
            <VCard>
                ...
                <DataTable v-else :rows="5" :value="dataSource" :loading="loadSearch" :rowsPerPageOptions="[5, 10, 15]"
                    ...
                    <Column field="JmlTindakan" header="JUMLAH" />
                </DataTable>
            </VCard>
        </div>
    </section>
...
const exportExcel = () => {
    ...
    const worksheet = XLSX.utils.aoa_to_sheet([
        ['FORMULIR RL 3.10 - PELAYANAN KHUSUS'],
        [],
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'RL 3.10', true);
    XLSXStyle.writeFile(workbook, 'FORMULIR RL 3.10 - PELAYANAN KHUSUS.xlsx');
}
fetchData()
