            ...
            <VCard>
                <div class="column c-title pt-2 mb-0">
                    <div class="column is-10 p-0">
                        ...
                        <label for="">FARMASI RUMAH SAKIT</label>
                    </div>
                </div>
                ...
                <DataTable v-else :rows="5" :value="dataSource" :loading="loadSearch" :rowsPerPageOptions="[5, 10, 15]"
                    ...
                    <Column field="detailobat" header="GOLONGAN OBAT" />
                    <Column field="jumlah" header="JUMLAH ITEM OBAT" />
                    <Column field="jumlahtersedia" header="JUMLAH ITEM OBAT TERSEDIA" />
                    <Column field="jumlahfortersedia" header="JUMLAH ITEM OBAT FORMULATORIUM TERSEDIA" />
                </DataTable>
            </VCard>
        </div>
    </section>
...
const exportExcel = () => {
    ...
    const worksheet = XLSX.utils.aoa_to_sheet([
        ['FORMULIR RL 3.13 - FARMASI RUMAH SAKIT'],
        [],
        ['NO', 'GOLONGAN OBAT', 'JUMLAH ITEM OBAT', 'JUMLAH ITEM OBAT TERSEDIA', 'JUMLAH ITEM OBAT FORMULATORIUM TERSEDIA'],
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'FORMULIR RL 3.13', true);
    XLSXStyle.writeFile(workbook, 'RL 3.13 FARMASI RUMAH SAKIT.xlsx');
}
