                ...
                <div class="column is-12">
                  <a class="flight-summary">
                    ...
                    <div class="meta" style="margin-left: 12rem;">
                      <TdaftarDistribusi @batalKirim="batalKirim(items)" @editItems="editDis(items)" @cetakBuktiKirim="cetakBuktiKirim(items)"  @gotoRetur="gotoRetur(items)"/>
