    ...
    <div>
        <div class="update-item is-dark-bordered-12 " style="display: block;" v-if="props.items.length == 0">
            <div class="search-results-wrapper">
                <VButton icon="feather:plus" color="info" @click="$emit('addItems')">
                    Tambah
                </VButton>
                <div class="search-results-body ">
                    ...
                    <div class="page-placeholder">
                        <div class="placeholder-content">
                            <img class="light-image" style=" max-width: 300px;"
                                src="/images/simrs/not-found-emr.png" alt="" />
                            <img class="dark-image" style=" max-width: 300px;"
