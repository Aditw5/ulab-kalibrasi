                                ...
                                <div class="box-text" style="width:70%">
                                    <div class="meta-text">
                                        <table class="tb-order">
                                            ...
                                            <tr v-if="item.status_tunda === true">
                                                <td>Ditunda</td>
                                                <td>:</td>
                                                <td class="text-value">{{ item.kettunda }}</td>
                                            </tr>
                                ...
                                <div class="box-end" style="width:30%">
                                    <div class="columns is-multiline">
                                        ...
                                        <div class="column is-12 ">
                                            <VIconButton icon="feather:file-text" @click="$emit('hasilItems', item)" raised
                                            ...
                                            <VIconButton icon="feather:edit" @click="$emit('editItems', item)" color="info"
                                                raised circle class="mr-2 is-pulled-right" v-tooltip.bubble="'Edit'"
                                                v-if="!isHideEdit">
                                            </VIconButton>
                                            <!-- <VIconButton icon="feather:printer" @click="$emit('cetakItems', item)"
                                                color="warning" :disabled="item.norec_hr ? false : true" raised circle
                                                class="mr-2 is-pulled-right" v-tooltip.bubble="'Cetak'" v-if="!isHideEdit">
                                            </VIconButton> -->
                                        </div>
