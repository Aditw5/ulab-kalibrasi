  ...
  <div class="column">
    <VCard>
              ...
              <div class="column is-3">
                <div class=" columns is-multiline">
                  ...
                  <div class="column is-12">
                    <VField addons>
                      <VControl>
                        <VInput type="text" class="input" placeholder="PB" v-model="input.tb" />
                      </VControl>
              ...
              <div class="column is-3">
                <div class=" columns is-multiline">
                  ...
                  <div class="column is-12">
                    <VField addons>
                      <VControl>
                        <VInput type="text" class="input" placeholder="LK" v-model="input.lk" />
                      </VControl>
                      <VControl class="field-addon-body">
                        <VButton static>cm</VButton>
                      </VControl>
              ...
              <div class="column is-3">
                <div class=" columns is-multiline">
                  ...
                  <div class="column is-12">
                    <VField addons>
                      <VControl>
                        <VInput type="text" class="input" placeholder="LD" v-model="input.ld" />
                      </VControl>
                      <VControl class="field-addon-body">
                        <VButton static>cm</VButton>
                      </VControl>
      ...
      <div class="column is-12" style="width:100%; overflow-x: scroll;">
        <Fieldset :toggleable="true" legend="Detail Observasi Obgyn">
                ...
                <table class="tg" style="table-layout: fixed; width: 100%;">
                  <thead>
                    <tr>
                      ...
                      <th style="width: 150px !important;">TGL</th>
                      <th style="width: 150px !important;">JAM</th>
                      <th style="width: 150px !important;">TEMP.</th>
                      <th style="width: 150px !important;">HR</th>
                      <th style="width: 150px !important;">RR</th>
                      <th style="width: 150px !important;">SpO2</th>
                      <th colspan="4" class="text-center" style="width: 600px !important;">MINUM</th>
                      <th style="width: 150px !important;">BAK</th>
                      <th style="width: 150px !important;">BAB</th>
                  ...
                  <tbody>
                    <tr v-for="(data, index) in input.detailObservasi" :key="index">
                      ...
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.tgl" type="date" placeholder="Tanggal" />
                          </VControl>
                        </VField>
                      </td>
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.jam" type="time" placeholder="Jam" />
                          </VControl>
                        </VField>
                      </td>
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.temp" type="text" placeholder="Temp." />
                          </VControl>
                        </VField>
                      </td>
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.hr" type="text" placeholder="HR" />
                          </VControl>
                        </VField>
                      </td>
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.rr" type="text" placeholder="RR" />
                          </VControl>
                        </VField>
                      </td>
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.spo2" type="text" placeholder="SpO2" />
                          </VControl>
                        </VField>
                      </td>
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.volume" type="text" placeholder="Volume" />
                          </VControl>
                        </VField>
                      </td>
                      <td>
                      ...
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.kembung" type="text" placeholder="Kembung" />
                          </VControl>
                        </VField>
                      </td>
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.residu" type="text" placeholder="Residu" />
                          </VControl>
                        </VField>
                      </td>
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.bak" type="text" placeholder="BAK" />
                          </VControl>
                        </VField>
                      </td>
                      <td>
                        <VField>
                          <VControl>
                            <VInput v-model="data.bab" type="text" placeholder="BAB" />
                          </VControl>
                        </VField>
                      </td>
                      <td>
      ...
      <div class="columns is-multiline">
        <div class="column is-4" style="margin-left: auto;">
          <VCard>
            <h1 style="font-weight: bold; text-align: center"> Dokter Obgyn </h1>
            <div class="mt-6">
            ...
            <div class="mt-2">
              <VField>
                <VControl class="prime-auto">
                  <AutoComplete v-model="input.ahliObgyn" :suggestions="d_Dokter"
                    @complete="fetchDokter($event)" :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'"
...
const COLLECTION: any = ref('lembarObservasiObgyn') //table mongodb
