    ...
    <VCard>
      <div class="columns is-multiline">
        <div class="column is-12">
          <h1 style="font-weight: bold;" class="text-center mb-5">SURAT PERNYATAAN PASIEN RAWAT INAP</h1>
        </div>
        <div class="column is-12">
          ...
          <div class="column is-12 p-0">
            <div class="is-flex">
              ...
              <div class="column is-6">
                <VField>
                  <VControl>
                    <VInput type="text" class="input" placeholder="No Telpon / HP... " v-model="input.notelpon" />
                  </VControl>
                </VField>
              </div>
            </div>
          ...
          <div class="column is-12 p-0">
            <div class="is-flex">
              ...
              <div class="column is-6">
                <VField>
                  <VControl>
                    <VInput type="text" class="input" placeholder="Hubungan dengan pasien... " v-model="input.hubunganDenganPasien" />
                  </VControl>
                </VField>
              </div>
            </div>
                ...
                <VControl>
                  <div class="columns is-multiline pt-3 pb-2 pr-5 pl-3">
                    ...
                    <div class="column is-4 mt-2 p-0" v-for="items in d_JK" :key="items.id">
                      <VRadio v-model="input.menyatakanBahwa" :value="items.label" class="p-0 mb-3" :label="items.label"
          ...
          <div class="column is-12 p-0">
            <div class="is-flex">
              <div class="column is-3" style="margin-top:0.5rem">
                <span>bersedia di rawat di Ruang : </span>
              </div>
          ...
          <div class="column is-12 p-0">
            <div class="is-flex">
              <div class="column is-2" style="margin-top:0.5rem">
                <span> Dengan Tarif Akomodasi </span>
              </div>
              <div class="column is-5">
                <div class="is-flex">
                  <p style="margin-top:0.5rem; margin-right:0.5rem;">Rp. </p>
                  <VField>
                    <VControl>
                      <VInput type="text" class="input" placeholder="Harga... " v-model="input.tarifAkomodasi" />
                    </VControl>
                  </VField>
                  <p style="margin-top:0.5rem; margin-left:0.5rem;">perhari</p>
                </div>
                <p style="margin-top:0.5rem; margin-right:0.5rem;">Belum termasuk Jasa Pelayanan dan Jasa Tindakan</p>
              </div>
            </div>
          </div>
          <h1 style="font-weight: 600;">Pembayaran akan dilakukan melalui</h1>
          <div class="column is-12 p-0">
            <div class="">
              <div class="column is-6">
                <VControl>
                  <div class="columns is-multiline pt-3 pb-2 pr-5 pl-3">
                    <div class="column is-12" v-if="d_Pembayaran.length == 0">
                      <VPlaceloadText :lines="1" />
                    </div>
                    <div class="column is-4 mt-2 p-0" v-for="items in d_Pembayaran" :key="items.id">
                      <VRadio v-model="input.pembayaranAkanDilakukan" :value="items.label" class="p-0 mb-3" :label="items.label"
                        square color="primary" />
                        <VField v-if="items.label == 'Perusahaan'">
                          <VControl>
                            <VInput type="text" class="input" placeholder="perusahaan... " v-model="input.perusahaanPenanggung" />
                          </VControl>
                        </VField>
                    </div>
                  </div>
          ...
          <h1 style="font-weight: 600;">Selanjutnya saya dan keluarga saya akan mentaati semua ketentuan yang berlaku di RSUD Gunung Jati Kota Cirebon</h1>
          <h1 style="font-weight: 600;">Demikian pernyataan ini saya buat dengan sebenar-benarnya</h1>
          <div class="column is-12 p-0">
            <div class="column is-12">
              <div class="columns is-multiline">
                  <div class="column is-6">
                  ...
                  <div class="column is-4">
                      <h1 class="p-0" style="font-weight: bold;">Petugas Pendaftaran </h1>
                      <VField>
                          <VControl class="prime-auto">
                              <AutoComplete v-model="input.petugasPerawat" :suggestions="d_Pegawai"
                                  @complete="fetchPegawai($event)" :optionLabel="'label'" :dropdown="true"
                                  :minLength="3" :appendTo="'body'" :loadingIcon="'pi pi-spinner'"
                                  :field="'label'" placeholder="Petugas Pendaftaran..." class="mt-2"
                                  @item-select="setTandaTangan($event)" />
                          </VControl>
                      </VField>
                  </div>
                  <div class="column is-4 is-offset-2">
                      <h1 class="p-0" style="font-weight: bold;">Hormat Saya</h1>
                      <VField>
                          <VControl>
...
const listPembayaran = [
  ...
  // {value: 3, label: "Perusahaan", list : [
  //   {value: 1, label: "Jamsostek"},
  //   {value: 2, label: "PT. KAI"},
  //   {value: 3, label: "Kontraktor"}
  // ]},
  {value: 4, label: "Bayar Tunai / Umum"},
]
d_Pembayaran.value = listPembayaran
