<template>
    ...
    <Fieldset v-for="(item, indexData) in input.details" :legend="`Peresetujuan ke ${item.no}`" :toggleable="true">
          ...
          <div class="column is-6">
            <VField class="pt-3">
              <VControl class="prime-auto">
                <AutoComplete v-model="item.dokterDPJP" :suggestions="d_Dokter" @complete="fetchDokter($event)" :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'" :loadingIcon="'pi pi-spinner'" :field="'label'" placeholder="Cari Dokter..." />
              </VControl>
            </VField>
          </div>
        </div>
      ...
      <vCard>
          ...
          <tbody>
            ...
            <td>
                <VField>
                    <VControl>
                        <div class="is-primary-focus" style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9;">
                        Anamnesis, Pemeriksaan fisik, Pemeriksaan Penunjang (USG, Rontgen, Laboratorium)
                        </div>
                    </VControl>
                </VField>
            </td>
          ...
          <tr>
            ...
            <td>
              <VField>
                <VControl>
                    <div class="is-primary-focus" style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9;">
                        1. Infant & anak usia muda <br>
                        2. Dewasa yang memilih anestesi umum <br>
                        3. Pembedahan yang luas/ekstensif <br>
                        4. Penderita yang sakit mental
                    </div>
                </VControl>
            </VField>
            </td>
          ...
          <tr>
            ...
            <td>
                <VField>
                    <VControl>
                        <div class="is-primary-focus" style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9;">
                            1. Parental, baik intravena (obat disuntikan ke pembuluh darah) maupun intramuscular (obat disuntikan kedalam otot) <br>
                            2. Obat dimasukan kedalam anus (perrectal) <br>
                            3. Perinhalasi, melalui pernafasan, menggunakan gas atau cairan anestesi
                        </div>
                    </VControl>
                </VField>
            </td>
          ...
          <tr>
            ...
            <td>
                <VField>
                    <VControl>
                        <div class="is-primary-focus" style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9;">
                            Hilangnya kesadaran, hilangnya respon terhadap nyeri, kontrol absolut jalan nafas/pernafasan
                        </div>
                    </VControl>
                </VField>
            </td>
          ...
          <tr>
            ...
            <td>
                <VField>
                    <VControl>
                        <div class="is-primary-focus" style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9;">
                            1. Reaksi anafilaktik/alergi <br>
                            2. Aspirasi <br>
                            3. Komplikasi kardiovaskuler : hipotensi, hipertensi, aritmia, payah jantung <br>
                            4. Komplikasi pernafasan : obsiruksi jalan nafas, batuk, cekukan (hiccup), apneu (henti nafas), pneumothoraks, muntah dan regurgitasi <br>
                            5. Komplikasi neurologi : kejang, terlambat sadar, cedera saraf tepi (perifer)
                        </div>
                    </VControl>
                </VField>
            </td>
            ...
            <tr>
              ...
              <td>
                <VField>
                    <VControl>
                        <div class="is-primary-focus" style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9;">
                        Lokal anestesi atau spinal anestesi
                        </div>
                    </VControl>
                </VField>
              </td>
        ...
        <div class="columns is-multiline">
          ...
          <div class="column is-3" style="text-align: center;">
            ...
            <div class="column pl-0 pr-0 pt-5">
              <VField class="pt-2">
                <VControl class="prime-auto">
                  <AutoComplete v-model="item.dokterMenyatakan" :suggestions="d_Dokter" @complete="fetchDokter($event)" :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'" :loadingIcon="'pi pi-spinner'" :field="'label'" placeholder="Cari Dokter..." />
                </VControl>
              </VField>
            </div>
          </div>
        ...
        <div class="columns is-multiline">
          <div class="column is-9">
            <h1 class="mt-3">Dengan ini menyatakan bahwa saya/keluarga pasien telah menerima informasi sebagaimana di atas
              yang saya beri
      ...
      <vCard>
        ...
        Saya juga menyadari bahwa ilmu kedokteran bukanlah ilmu pasti, maka keberhasilan tindakan (Anastesi Umum) bukanlah
