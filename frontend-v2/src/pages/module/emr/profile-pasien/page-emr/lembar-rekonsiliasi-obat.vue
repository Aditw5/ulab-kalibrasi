              ...
              <div class="column is-8">
                <div class="columns is-multiline">
                  <div class="column is-6">
                    ...
                    <img v-if="input.perawatObatDibawaPasien"
                      :src="'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=' + (input.perawatObatDibawaPasien ? input.perawatObatDibawaPasien.label : '-')">
                  </div>
                  <div class="column is-6 ">
                    <!-- <TandaTangan :elemenID="'signature_1'" :width="'180'" :height="'180'"></TandaTangan> -->
                    <img v-if="input.apotekerObatDibawaPasien"
                      :src="'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=' + (input.apotekerObatDibawaPasien ? input.apotekerObatDibawaPasien.label : '-')">
                  </div>
                  <div class="column is-4">
...
const setAutoFill = async () => {
  ...
  input.value.perawatObatDibawaPasien = { label: useUserSession().getUser().pegawai.namaLengkap, value: useUserSession().getUser().pegawai.id }
