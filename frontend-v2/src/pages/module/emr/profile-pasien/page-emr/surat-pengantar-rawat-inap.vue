            ...
            <div class="column is-12 px-4">
              ...
              <div class="column is-12 py-0 px-4">
                <div class="columns is-multiline mt-3">
                  ...
                  <div class="column is-6">
                    <VField label="Dokter DPJP" class="is-rounded-select_Z  is-autocomplete-select" v-slot="{ id }">
                      <VControl icon="fas fa-hospital-alt">
                        <AutoComplete v-model="input.dokterDPJP1" :suggestions="d_Dokter" @complete="fetchDokter($event)"
                        :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'"
              ...
              <div class="column is-12 mt-3">
                <div class="columns is-multiline mt-2">
                  ...
                  <div class="column is-12 py-0 px-4">
                    ...
                    <VField label="Dokter DPJP" class="is-rounded-select_Z  is-autocomplete-select" v-slot="{ id }">
                      <VControl icon="fas fa-hospital-alt">
                        <AutoComplete v-model="input.dokterDPJPRanap" :suggestions="d_Dokter" @complete="fetchDokter($event)"
                        :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'"
                        :loadingIcon="'pi pi-spinner'" :field="'label'" placeholder="Dokter DPJP"
                       />
                      </VControl>
