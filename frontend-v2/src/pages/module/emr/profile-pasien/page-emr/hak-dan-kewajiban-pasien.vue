    ...
    <div class="columns is-multiline p-2">
        <div class="column is-12">
            <VCard>
                ...
                <h1 style="font-weight: bold; text-align: center;"> (sesuai pasal 32 UU No.44 tahun 2009) </h1>
                <div class="columns is-multiline">
                    <div class="column is-12">
                        <div class="column is-12">
                            ...
                            <p>
                                8. Meminta konsultasi tentang penyakit yang dideritanya kepada dokter lain yang mempunyai Surat Izin Prakter (SIP) baik di dalam maupun di luar Rumah
                                Sakit.
                            </p>
                            <p>
                            ...
                            <p>
                                10. Mendapat informasi yang meliputi diagnosis dan tata cara tindakan medis, tujuan tindakan medis, alternatif tindakan, risiko dan komplikasi yang mungkin terjadi, dan progronis terhadap tindakan yang dilakukan serta perkiraan biaya pengobatan.
                            </p>
                            <p>
                            ...
                            <p>
                                16. Menolak layanan bimbingan rohani yang tidak sesuai dengan agama dan kepercayaan yang
                                dianutnya.
                            </p>
                            <p>
                        ...
                        <div class="column is-12">
                            ...
                            <p>
                                5. Memenuhi kewajiban finansial yang disepakati.
                            </p>
                        </div>
                        ...
                        <div class="column is-12">
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-6 ">
                                    ...
                                    <img v-if="input.petugasPendaftaran"
                                        :src="'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=' + (input.petugasPendaftaran ? input.petugasPendaftaran.label : '-')">
                                </div>
                                <div class="column is-4 ">
                                ...
                                <div class="column is-4 is-offset-2">
                                    <h1 class="p-0" style="font-weight: bold;">Mengetahui Petugas Pendaftaran</h1>
                                    <VField>
                                        <VControl class="prime-auto">
                                            <AutoComplete v-model="input.petugasPendaftaran" :suggestions="d_Dokter"
...
const setAutoFill = async () => {
    ...
    input.value.petugasPendaftaran = { label: useUserSession().getUser().pegawai.namaLengkap, value: useUserSession().getUser().pegawai.id }
}
setView()
setAutoFill()
loadRiwayat()
