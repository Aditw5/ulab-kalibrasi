        ...
        <div class="columns is-multiline">
          <div class="column is-12">
            ...
            <div class="column is-12 p-0">
              <div class="is-flex">
                <div class="column is-2" style="margin-top:0.5rem">
                  <span>  Dengan ini mengajukan Permintaan Pelayanan Rohaniwan Agama (beri Tanda ✔): </span>
                </div>
                <div class="column is-6">
                    <div class="column is-12">
                       <div class="is-flex">
                            <VField v-for="items in d_agama" :key="items.value" style="padding:0px;">
                                <div class="column is-4">
                                    <VControl raw subcontrol>
                                      <VCheckbox v-model="input.agama" class="pt-1 pb-1 " :true-value="items.label"
            ...
            <h1 style="font-weight: bold;">Demikian Permintaan Pelayanan Rohani ini saya buat, untuk dapat dipergunakan sebagaimana mestinya.</h1>
            <table align="center" class="triase" style="width: 90%; margin-top: 2rem;">
                <tr>
                    <th colspan="4" style="text-align : center"> PELAYANAN ROHANI </th>
                </tr>
                <tr>
                    <th style="text-align : center"> No </th>
                    <th style="text-align : center"> Masalah </th>
                    <th style="text-align: center"> Bimbingan Rohani </th>
                ...
                <tr>
                    ...
                    <td>
                        <VField>
                            <VControl>
                                <VTextarea rows="2" v-model="input.masalah1"
                                    placeholder="" />
                            </VControl>
                        </VField>
                    </td>
                    <td>
                        <VField>
                            <VControl>
                                <VTextarea rows="2" v-model="input.bimbinganRohani1"
                                    placeholder="" />
                            </VControl>
                        </VField>
                    </td>
                    <td>
                        <VField>
                            <VControl>
                                <VTextarea rows="2" v-model="input.keterangan"
                                    placeholder="" />
                            </VControl>
                        </VField>
                    </td>
            ...
            <div class="column is-12">
              <div class="columns is-multiline">
                ...
                <div class="column is-4">
                  <h1 class="p-0" style="font-weight: bold;">Tanda Tangan Petugas Rohaniwan</h1>
                  <VField>
                    <VControl class="prime-auto">
                      <AutoComplete v-model="input.petugasrohaniawan" :suggestions="d_Dokter" @complete="fetchDokter($event)"
                        :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'"
                        :loadingIcon="'pi pi-spinner'" :field="'label'" placeholder="Nama..." class="mt-2"
                        @item-select="setTandaTangan($event)" />
                      </VControl>
                    </VField>
                  </div>
                  <div class="column is-4 is-offset-2">
                  <h1 class="p-0" style="font-weight: bold;">Tanda Tangan Penerima Pelayanan Rohani </h1>
                  <VField>
                    <VControl>
                      <VInput type="text" class="input" placeholder="Nama" v-model="input.penerima" />
                    </VControl>
                  </VField>
                </div>
              </div>
