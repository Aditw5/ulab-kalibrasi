                    ...
                    <div class="column is-12">
                        ...
                        <div class="column is-4" style="margin-left: auto;">
                            <VCard>
                                ...
                                <div class="column p-0">
                                    <div class="column">
                                        <img v-if="input.petugas"
                                            :src="'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=' + (input.petugas ? input.petugas.label : '-')">
                                    </div>
                                </div>
                                <div class="column p-0">
...
const setAutoFill = async () => {
  input.value.petugas = { label: useUserSession().getUser().pegawai.namaLengkap, value: useUserSession().getUser().pegawai.id }
}
