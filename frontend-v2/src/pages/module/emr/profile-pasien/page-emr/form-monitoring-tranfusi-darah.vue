                            ...
                            <table class="tc">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="tg-0lax text-center" rowspan="2">Kantong</td>
                                        <td class="tg-0lax text-center" colspan="4">TTV </td>
                                        <td class="tg-0lax text-center" rowspan="2">Lokasi Insersi</td>
                                        <td class="tg-0lax text-center" rowspan="2">Nama Perawat</td>
                                        <td class="tg-0lax text-center" rowspan="2">Paraf</td>
                                        <td class="tg-0lax text-center" rowspan="2">Reaksi Alergi</td>
                                        <td class="tg-0lax text-center" rowspan="2">Keterangan</td>
                                        <td class="tg-0lax text-center" rowspan="2">#</td>
                                    </tr>
                                    <tr>
                                        <td class="tg-0lax" style="text-align: center;">TD </td>
                                        <td class="tg-0lax" style="text-align: center;">HR </td>
                                        <td class="tg-0lax" style="text-align: center;">RR</td>
                                        <td class="tg-0lax" style="text-align: center;">S</td>
                                    </tr>
                                </thead>
                                <tbody v-for="(item, index) in input.details" :key="index">
                                    <tr>
                                        ...
                                        <td>
                                            <VField>
                                                <VControl>
                                                    <VTextarea v-model="item.paraf" rows="2">
                                                    </VTextarea>
                                                </VControl>
                                            </VField>
                                        </td>
                                        <td>
                                            <VField>
                                                <VControl>
                                                    <VTextarea v-model="item.reaksiAlergi" rows="2">
                                                    </VTextarea>
                                                </VControl>
                                            </VField>
                                        </td>
