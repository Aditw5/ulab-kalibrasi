        ...
        <div class="column is-12">
            <VCard>
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12">
                        <Fieldset class="p-fieldsets" legend="PERSETUJUAN TINDAKAN TRANSFUSI DARAH" :toggleable="true">
                            <div class="column is-12">
                                ...
                                <div class="column is-12">
                                    <div class="flex">
                                        <h1 style="font-weight: bold">
                                            Dengan ini menyatakan sesungguhnya, bahwa saya telah menerima informasi yang diberikan oleh Petugas sebagaimana di atas dan telah memahaminya. Untuk itu saya memberikan PERSETUJUAN untuk diberikan TRANSFUSI DARAH terhadap.
                                        </h1>
                                    </div>
                                </div>
                                <div class="column is-12 p-0">
                                ...
                                <div class="column is-12">
                                    <h1 style="font-weight: bold">Saya memahami perlunya dan manfaat tindakan tersebut termasuk risiko dan komplikasi yang akan timbul bila tidak dilakukan tindakan tersebut, dan bila saat atau setelah atau dikemudian hari terjadi keadaan penyulit akibat tindakan TRANSFUSI DARAH, Saya tidak akan menyalahkan siapapun.</h1>
                                </div>
                                <!-- <div class="column is-12">
                                    <h1 style="font-weight: bold">
                                        Alasan Penolakan
...
import * as EMR from '../page-emr-plugins/persetujuan-tindakan-transfusi-darah'
...
const COLLECTION: any = ref('PersetujuanTindakanPemakaianDarah') //table mongodb
