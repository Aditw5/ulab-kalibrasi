              ...
              <table class="table-ptv table-fkprj">
                <thead>
                  <tr class="tr-fkprj">
                    ...
                    <th class="th-fkprj" style="text-align: center;">TD (mmHg)</th>
                    <th class="th-fkprj" style="text-align: center;">Suhu (<sup>o</sup>C)</th>
                    <th class="th-fkprj" style="text-align: center;">Nadi (x/Mnt)</th>
                    <th class="th-fkprj" style="text-align: center;">RR (x/Mnt)</th>
                    <th class="th-fkprj" style="text-align: center;">SPO2 (%)</th>
                    <th class="th-fkprj" style="text-align: center;">GCS</th>
                    <th class="th-fkprj" style="text-align: center;">EWS</th>
                    <th class="th-fkprj" style="text-align: center;">PEWS</th>
                    <th class="th-fkprj" style="text-align: center;">Pupil</th>
                    <th class="th-fkprj" style="text-align: center;">Nyeri</th>
                    <th class="th-fkprj" style="text-align: center;">Nama & Paraf</th>
                    <th class="th-fkprj" style="vertical-align:inherit;text-align: center;" width="2%">Aksi
                    </th>
                  </tr>
                </thead>
                <tbody v-for="(item, index) in input.diagnosisKerja" :key="index">
                  <tr class="tr-fkprj">
                    ...
                    <td class="td-fkprj">
                      <VField addons>
                        <VControl>
                          <VInput type="text" class="input" placeholder="SP02" v-model="item.SPO2" />
                        </VControl>
                        <VControl class="field-addon-body">
                    ...
                    <td class="td-fkprj">
                      <VField addons>
                        <VControl>
                          <VInput type="text" class="input" placeholder="GCS" v-model="item.GCS" />
                        </VControl>
                      </VField>
                    </td>
                    <td class="td-fkprj">
                      <VField addons>
                        <VControl>
                          <VInput type="text" class="input" placeholder="EWS" v-model="item.EWS" />
                        </VControl>
                      </VField>
                    </td>
                    <td class="td-fkprj">
                      <VField addons>
                        <VControl>
                          <VInput type="text" class="input" placeholder="PEWS" v-model="item.PEWS" />
                        </VControl>
                      </VField>
                    </td>
                    <td class="td-fkprj">
                      <VField addons>
                        <VControl>
                          <VInput type="text" class="input" placeholder="Pupil" v-model="item.Pupil" />
                        </VControl>
                      </VField>
                    </td>
                    <td class="td-fkprj">
                        ...
                        <div class="column is-12">
                          <VField>
                            <VControl class="prime-auto">
                              <AutoComplete v-model="item.namaParafPetugas" :suggestions="d_Pegawai" @complete="fetchPegawai($event)"
