...
:isLoading="isLoading" @simpan="simpan"
  ...
  <vCard>
        ...
        <tr>
          ...
          <td>
            <VField>
              <VControl>
    <div class="is-primary-focus" style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9;">
      1. Penyelamat hidup dan suportif<br>
      2. Mekanik: Respiratori rate 35 kali/menit, tidal volume, &lt; 5 cc/kg BB, Maksimum inspiratory forse &lt; 20 mmHg. Oksigenasi/ Pa02 &lt; 60 mmHg
      dgn FiO2 room air 21%, Pa02 &lt; 70 mmHg dgn FiO2 room air 40%, PA02 &lt; 100 mmHg dgn FiO2 room air 100%
    </div>
  </VControl>
</VField>
          </td>
        ...
        <tr>
          ...
          <td>
            <VField>
              <VControl>
    <div class="is-primary-focus" style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9;">
      1. Oksigenisasi dan Ventilasi<br>
      2. Memberikan kekuatan mekanis pada paru untuk mempertahankan O2 dan CO2 yang fisiologis, mengambil alih (manipulasi) tekanan jalan nagas dan pola
      pernafasan untuk memperbaiki pertukaran  O2 dan CO2 secara efisien dan oksigenisasi yang kuat, mengurangi kerja otot jantung dengan jalan mengurangi kerja paru
    </div>
  </VControl>
</VField>
          </td>
    ...
    <VControl>
      <div class="is-primary-focus" style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9;">
        Pneumothorak, VAP, emfisema subcutis, aspirasi cairan sirkui
      </div>
    </VControl>
  </VField>
          </td>
      ...
      <div class="is-primary-focus" style="border: 1px solid #ccc; padding: 10px; background-color: #f9f9f9;">
        ...
        <tr>
          ...
          <td>
            <VField>
              <VControl>
                <VTextarea v-model="input.lainLainAlternatif" class="is-primary-focus" rows="2"
          ...
          <td class="is-end">
            <VControl raw subcontrol>
              <VCheckbox v-model="input.optionLainLainAlternatif" color="primary" />
            </VControl>
          </td>
        </tr>
      </tbody>
  ...
  <vCard>
    <h3 class="title is-5 mb-2" style="text-align: center">Penolakan Tindakan</h3>
    <p>
    <div class="columns is-multiline">
    ...
    <div class="columns is-multiline">
      ...
      <div class="column is-8">
        <VField class="pt-3">
          <VControl>
            <VInput type="text" v-model="input.tglLahir" />
          </VControl>
        </VField>
      </div>
    </div>
    <div class="columns is-multiline">
      ...
      <div class="column is-8">
        <VField class="pt-3">
          <VControl>
            <VInput type="text" v-model="input.jenisKelamin" />
          </VControl>
        </VField>
      </div>
    </div>
    <div class="columns is-multiline">
      ...
      <div class="column is-8">
        <VField class="pt-3">
          <VControl>
            <VInput type="text" v-model="input.alamatPasien" />
          </VControl>
        </VField>
      </div>
    </div>
    <div class="columns is-multiline">
      <div class="column is-4">
        <h1 class="mt-3">Dengan ini menyatakan penolakan untuk dilakukan tindakan terhadap saya /</h1>
      </div>
      <div class="column is-8">
        <VField class="pt-3">
          <VControl>
    ...
    <div class="columns is-multiline">
      <div class="column is-4" style="text-align: center;">
        ...
        <div class="column pl-0 pr-0 pt-5">
          <VField class="pt-3">
            <VControl class="prime-auto">
              <VInput type="text" v-model="input.pasienYangMenyatakan" />
            </VControl>
          </VField>
        </div>
      </div>
...
const COLLECTION: any = ref('penolakanTindakanVentilator') //table mongodb
...
const setAutoFill = async () => {
  ...
  input.value.pasienYangMenyatakan = props.pasien.namapasien
