...
const COLLECTION: any = ref("laporanPACF") //table mongodb
...
const setAutoFill = async () => {
  ...
  input.value.noTindakan = '- - - -PACF'
  input.value.tglTindakan = H.formatDate(new Date(), 'YYYY-MM-DD')
  input.value.keteranganLaporan = `
    1 Tindakan a/antiseptik di dareah femoral kanan.
    2 Dilakukan anestesi sekitar femoralis kanan dengan Lidocain 2%
    3 Punksi arteri femoralis kanan berjalan lancar sheath [ISI INFORMASI] dimasukkan
    4 Dilakukan kanulasi LCA dan RCA dengan [ISI INFORMASI] angiografi menunjukan :
      LM    :   [ISI INFORMASI]
      LAD   :   [ISI INFORMASI]
      LCX   :   [ISI INFORMASI]
      RCA   :   [ISI INFORMASI]
    5 Tindakan selesai, hemodinamik pasien selama dan sesudah tindakan stabil.
    6 Kontras yang digunakan: [ISI INFORMASI] jumlah: [ISI INFORMASI] perdarahan [ISI INFORMASI]
  `
