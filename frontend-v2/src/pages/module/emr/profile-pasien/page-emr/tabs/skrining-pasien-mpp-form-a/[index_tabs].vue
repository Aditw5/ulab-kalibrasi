        ...
        <tbody>
          <tr >
            <td width="10%">
              <VField>
                <VControl class="prime-auto">
                  <Calendar v-model="input.tanggalidentifikasi" selectionMode="single" :manualInput="true" class="w-100"
                    :showIcon="true" showTime hourFormat="24" :date-format="'yy-mm-dd'" :disabled="item.tgl2" />
                </VControl>
              </VField>
            </td>
            <td width="80%">
              <span> Identifikasi/Skrining Pasien </span>
              <VField>
                <VControl>
                  <VTextarea v-model="input.identifikasi" rows="5" placeholder="Identifikasi/Skrining Pasien"
          ...
          <tr>
            <td width="10%">
              <VField>
                <VControl class="prime-auto">
                  <Calendar v-model="input.tanggalasesmen" selectionMode="single" :manualInput="true" class="w-100"
                    :showIcon="true" showTime hourFormat="24" :date-format="'yy-mm-dd'" :disabled="item.tgl2" />
                </VControl>
              </VField>
            </td>
            <td width="80%">
              <span> Asesmen untuk manajemen pelayanan pasien </span>
              <VField>
                <VControl>
                  <VTextarea v-model="input.asesmen" rows="5" placeholder="Asesmen untuk manajemen pelayanan pasien"
                    style="padding-left: 30px;">
                  </VTextarea>
                </VControl>
              </VField>
          ...
          <tr>
            <td width="10%">
              <VField>
                <VControl class="prime-auto">
                  <Calendar v-model="input.tanggalidentifmasalah" selectionMode="single" :manualInput="true" class="w-100"
                    :showIcon="true" showTime hourFormat="24" :date-format="'yy-mm-dd'" :disabled="item.tgl2" />
                </VControl>
              </VField>
            </td>
            <td width="80%">
              <span> Identifikasi masalah-risiko-kesempatan </span>
              <VField>
                <VControl>
                  <VTextarea v-model="input.identifmasalah" rows="5" placeholder="Identifikasi masalah-risiko-kesempatan"
                    style="padding-left: 30px;">
                  </VTextarea>
                </VControl>
              </VField>
          ...
          <tr>
            <td width="10%">
              <VField>
                <VControl class="prime-auto">
                  <Calendar v-model="input.tanggalperencanaan" selectionMode="single" :manualInput="true" class="w-100"
                    :showIcon="true" showTime hourFormat="24" :date-format="'yy-mm-dd'" :disabled="item.tgl2" />
                </VControl>
              </VField>
            </td>
            <td width="80%">
              <span> Perencanaan manajemen pelayanan pasien </span>
              <VField>
                <VControl>
                  <VTextarea v-model="input.perencanaan" rows="5" placeholder="Perencanaan manajemen pelayanan pasien"
                    style="padding-left: 30px;">
                  </VTextarea>
                </VControl>
              </VField>
...
const COLLECTION: any = ref("SkrinningPasienMppFormA") //table mongodb
...
const input: any = ref({
  ...
  tanggalidentifikasi: new Date(),
  tanggalasesmen: new Date(),
  tanggalidentifmasalah: new Date(),
...
const simpan = () => {
  ...
  object = input.value
  input.value.tanggalidentifikasi = H.formatDate(new Date(input.value.tanggalidentifikasi), 'YYYY-MM-DD HH:mm')
  input.value.tanggalasesmen = H.formatDate(new Date(input.value.tanggalasesmen), 'YYYY-MM-DD HH:mm')
  input.value.tanggalidentifmasalah = H.formatDate(new Date(input.value.tanggalidentifmasalah), 'YYYY-MM-DD HH:mm')
  input.value.tanggalperencanaan = H.formatDate(new Date(input.value.tanggalperencanaan), 'YYYY-MM-DD HH:mm')
