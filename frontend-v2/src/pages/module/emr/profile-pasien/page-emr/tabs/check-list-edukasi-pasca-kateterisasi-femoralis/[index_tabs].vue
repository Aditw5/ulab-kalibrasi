...
import * as EMR from '../../../page-emr-plugins/cek-list-edukasi-pasca-kateterisasi-femoralis'
...
const COLLECTION: any = ref("CheckListEdukasiPascaKateterisasiFemoralis") //table mongodb
