...
const COLLECTION: any = ref("laporanPCIR") //table mongodb
...
const setAutoFill = async () => {
  ...
  input.value.noTindakan = '- - - -PCIR'
  input.value.tglTindakan = H.formatDate(new Date(), 'YYYY-MM-DD')
  input.value.keteranganLaporan = `
    1 Tindakan a/antiseptik di dareah radialis kanan.
    2 Dilakukan anestesi sekitar radialis kanan dengan Lidocain 2%
    3 Punksi arteri femoralis kanan berjalan lancar [ISI INFORMASI] dimasukkan
    4 Diberikan Heparin [ISI INFORMASI] UI iv
    5 Dilakukan kanulasi LCA dan RCA dengan [ISI INFORMASI] angiografi menunjukan :
      LM    :   [ISI INFORMASI]
      LAD   :   [ISI INFORMASI]
      LCX   :   [ISI INFORMASI]
      RCA   :   [ISI INFORMASI]
    6 PCI-[ISI INFORMASI] : Dilakukan kanulasi [ISI INFORMASI] dengan [ISI INFORMASI], Dilakukan wiring dengan [ISI INFORMASI] sampai ke [ISI INFORMASI]. DIlatasi [ISI INFORMASI] dengan balloon [ISI INFORMASI] mm yang dikembangkan dengan teknan [ISI INFORMASI] atm. Dilakukan stenting dengan DES [ISI INFORMASI] [ISI INFORMASI] mm yang dikembangkan dengan tekanan [ISI INFORMASI] atm di [ISI INFORMASI]. Evaluasi angiografi menunjukan hasil baik TIMI 3 flow.
    7 Tindakan selesai, hemodinamik pasien selama dan sesudah tindakan stabil.
    8 Kontras yang digunakan: [ISI INFORMASI] jumlah: [ISI INFORMASI] perdarahan [ISI INFORMASI]
  `
