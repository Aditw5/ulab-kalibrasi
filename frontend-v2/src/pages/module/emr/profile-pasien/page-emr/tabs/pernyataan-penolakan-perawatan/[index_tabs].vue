...
:isLoading="isLoading" @simpan="simpan"
  ...
  <div class="columns is-12">
    <VCard>
      <div class="column is-12 p-0">
        <div class="is-flex">
          ...
          <div class="column is-10">
            <VField>
              <VControl>
                <VInput type="text" class="input" placeholder="Nama" v-model="input.namaMenyatakan" />
              </VControl>
            </VField>
          </div>
        </div>
              ...
              <div class="columns is-6" style=" margin-top: 1rem">
                  <VField v-for="items in JenisKelamin" :key="items.value" style="padding:0px;">
                      <VControl raw subcontrol>
                          <VCheckbox v-model="input.jenisKelaminMenyatakan" class="pt-1 pb-1 "
      ...
      <div class="column is-12 p-0">
        <div class="is-flex">
          ...
          <div class="column is-10">
            <VField>
              <VControl class="prime-auto">
                <VInput type="text" class="input" placeholder="No Telpon" v-model="input.noTelponMenyatakan" />
              </VControl>
            </VField>
          </div>
        </div>
      ...
      <div class="column is-12 p-0">
        <div class="is-flex">
          Dan sayapun menyadari bahwa sewaktu-waktu mungkin dapat timbul suatu keadaan dimana bisa terjadi resiko atau akibat yang timbul dari penolakan perawatan medis tersebut diatas. Untuk hal tersebut diatas telah dijelaskan seluruh oleh dokter, dan saya telah memahami sepenuhnya dan bersedia menanggung seluruh resiko yang diakibatkan penolakan perawatan tersebut.
        </div>
      </div>
      ...
      <table class="tbl-kmNICU" style="margin-top: 30px;">
        ...
        <tr>
          ...
          <td>
            <div class="column is-12 text-center">Yang menyatakan,</div>
            <div class="column is-12">
              <VField>
              <VControl class="prime-auto">
        ...
        <tr>
          <td>
            <div class="column is-12 text-center">Saksi RSD Gunung Jati</div>
            <div class="column is-12">
              <VField>
              <VControl class="prime-auto">
...
const COLLECTION: any = ref("pernyataanPenolakanPerawatan") //table mongodb
