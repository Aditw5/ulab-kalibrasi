  ...
  <div class="columns is-12">
    <VCard>
      ...
      <table class="tbl-kmNICU">
        ...
        <tbody>
          <tr v-for="mpp in d_MPP">
            <td width="2%">{{mpp.no}}</td>
            <td width="6%">
              <VField>
                <VControl raw subcontrol>
                  <VCheckbox v-model="input[mpp.model]" color="primary" />
                </VControl>
              </VField>
            </td>
            <td v-html="mpp.isi_mpp"></td>
          </tr>
        </tbody>
      </table>
        ...
        <tr>
          <td>
            ...
            <div class="column is-12">
              <VField>
                    <VControl class="prime-auto">
                      <AutoComplete v-model="input.ppa" :suggestions="d_Dokter" @complete="fetchDokter($event)"
                        :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'"
                        :loadingIcon="'pi pi-spinner'" :field="'label'" placeholder="PPA" class="mt-2"/>
                    </VControl>
                  </VField>
            </div>
          </td>
          <td>
            ...
            <div class="column is-12">
              <img v-if="input.ppa"
                :src="'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=' + (input.ppa.label ? input.ppa.label : input.ppa)">
            </div>
          </td>
        </tr>
      </table>
...
import * as EMR from '../../../page-emr-plugins/cek-list-mpp'
...
const d_MPP = ref(EMR.cekListMPP())
...
const COLLECTION: any = ref("CheckListMPP") //table mongodb
