          ...
          <div class="form-outer" style="margin-top:15px">
              <div :class="[isStuck && 'is-stuck']" class="form-header stuck-header">
                  <div class="form-header-inner">
                      <div class="left">
                          <h3> NIPS (NEONATAL INFANT PAIN SCALE)</h3>
                      </div>
                      <div class="right">
                          <div class="buttons">
                              ...
                              <VCard class="border-card pink">
                                  <div class="columns is-multiline p-3">
                                      <div class="column is-12">
                                        <Fieldset class="p-fieldsets" legend="NIPS (NEONATAL INFANT PAIN SCALE)" :toggleable="true">
                                          <h1 class="emr"></h1>
                                          <div class="column is-12">
                                              <div class="columns is-multiline" style="border-bottom: 1px solid;">
                                                <div class="column is-2">
                                                  ...
                                                  <div class="column is-9">
                                                      <h1 class="emr">finding</h1>
                                                  </div>
                                                  <div class="column">
                                                      <h1 class="emr">Points</h1>
                                                  </div>
                                              ...
                                              <div class="columns is-multiline"
                                                  ...
                                                  <!-- <div class="column is-3" style="margin-left: auto;">
                                                    <VField>
                                                        <VControl raw subcontrol>
                                                            <input v-model="input.skorUmur" class="input v-else"
                                                                disabled />
                                                        </VControl>
                                                    </VField>
                                                  </div> -->
                                              ...
                                              <hr style="margin-top: 10px;">
                                              <div class="columns is-multiline"
                                                  v-for="(data) in resikoJatuh.keenam">
                                                  <div class="column is-2">
                                                      <h1 class="emr">{{ data.parameter }}</h1>
                                                  </div>
                                                  <div class="column is-9 pt-0">
                                              ...
                                              <hr style="margin-top: 10px;">
                                              <div class="columns is-multiline"
                                                  v-for="(data) in resikoJatuh.ketujuh">
                                                  <div class="column is-2">
                                                      <h1 class="emr">{{ data.parameter }}</h1>
                                                  </div>
                                                  <div class="column is-9 pt-0">
                                              ...
                                              <hr style="margin-top: 10px;">
                                              <div class="columns is-multiline"
                                                  v-for="(data) in resikoJatuh.kedelapan">
                                                  <div class="column is-2">
                                                      <h1 class="emr">{{ data.parameter }}</h1>
                                                  </div>
                                                  <div class="column is-9 pt-0">
                                          ...
                                          <div class="column is-12">
                                            <vcard>
                                              <div style="display: flex; justify-content: space-between;">
                                                  <div>
                                                      <p>Untuk bayi prematur di tambahkan 2 parameter yaitu : Heart Rate dan Saturasi Oksigen</p>
                                                  </div>
                                              </div>
                                            </vcard>
                                          </div>
                                  ...
                                  <div class="column is-12 p-0">
                                    ...
                                    <div class="columns is-multiline">
                                      <!-- Input Dokter untuk Tanda Tangan Pertama -->
                                      <div class="column is-4">
                                      ...
                                      <!-- Input Dokter untuk Tanda Tangan Kedua -->
                                      <div class="column is-4">
...
import * as EMR from '../page-emr-plugins/form-nips'
...
const COLLECTION: any = ref('FormNips') //table mongodb
...
watch(() => [
  input.value.ekspresiWajah,
  input.value.menangis,
  input.value.polaBernapas,
  input.value.lengan,
  input.value.kaki,
  input.value.ekspresiWajah2,
  input.value.heartRate,
  input.value.saturasiOksigen,
], () => {

  let poin1 = input.value.ekspresiWajah ? parseInt(input.value.ekspresiWajah.poin) : 0
  let poin2 = input.value.menangis ? parseInt(input.value.menangis.poin) : 0
  let poin3 = input.value.polaBernapas ? parseInt(input.value.polaBernapas.poin) : 0
  let poin4 = input.value.lengan ? parseInt(input.value.lengan.poin) : 0
  let poin5 = input.value.kaki ? parseInt(input.value.kaki.poin) : 0
  let poin6 = input.value.ekspresiWajah2 ? parseInt(input.value.ekspresiWajah2.poin) : 0
  let poin7 = input.value.heartRate ? parseInt(input.value.heartRate.poin) : 0
  let poin8 = input.value.saturasiOksigen ? parseInt(input.value.saturasiOksigen.poin) : 0


  const total = poin1 + poin2 + poin3 + poin4 + poin5 + poin6 + poin7 + poin8
