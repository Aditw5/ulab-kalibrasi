                                            ...
                                            <VField>
                                                <VControl>
                                                    <VInput type="text" class="input"
                                                        placeholder="Data Subjektif Lainnya"
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        ...
                                        <div class="column is-8">
                                            <VField>
                                                <VControl>
                                                    <VInput type="text" class="input"
                                                        placeholder="Data Objektif Lainnya"
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        ...
                                        <div class="column is-8 mr-3">
                                            <VField>
                                                <VControl>
                                                    <VInput type="text" class="input"
                                                        placeholder="Keterangan Terapeutik"
                                    ...
                                    <div class="columns is-multiline pt-3 pl-3">
                                        ...
                                        <div class="column is-8 mr-3">
                                            <VField>
                                                <VControl>
                                                    <VInput type="text" class="input"
                                                        placeholder="Keterangan Kolaborasi"
                            ...
                            <Fieldset :toggleable="true" legend="Evaluasi">
                                ...
                                <div class="column is-12">
                                    <div class="column is-multiline">
                                        ...
                                        <div class="column is-6">
                                            <img v-if="input.pegawai"
                                                :src="'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=' + (input.pegawai ? input.pegawai.label : '-')">
                                        </div>
...
const getDataExist = async () => {
    ...
    input.value.pegawai = { label: useUserSession().getUser().pegawai.namaLengkap, value: useUserSession().getUser().pegawai.id }
}
getDataExist()
