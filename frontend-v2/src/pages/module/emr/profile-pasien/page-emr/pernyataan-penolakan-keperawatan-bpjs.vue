        ...
        <div class="columns is-multiline">
          <div class="column is-12">
            ...
            <div class="column is-12 p-1">
              <h1>Saya telah mendapatkan informasi dari Petugas mengenai hak dan kewajiban saya serta tata tertib di RSJP Paramarta dengan demikian saya menyatakan   </h1>
            </div>
          
            <div class="column is-12 p-1">
              <h1> Tidak menggunakan fasilitas BPJS Kesehatan dan bersedia menanggung seluruh biaya perawatan di RSJP Paramarta.  </h1>
            </div>
            <div class="column is-12 p-1">
