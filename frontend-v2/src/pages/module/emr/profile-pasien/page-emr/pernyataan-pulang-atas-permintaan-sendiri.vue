    ...
    <VCard>
      <div class="column">
        ...
        <div class="columns is-multiline p-3">
          ...
          <div class="column is-12">
            <span class="label-ppap">Menyatakan dengan sesungguhnya bahwa pasien tersebut diatas akan dibawa pulang /
              keluar atas permintaan
              sendiri, dengan alasan:</span>
            <div class="columns is-multiline p-3">
              <div class="column is-4 pb-0" v-for="(data) in alasanPulang">
                <VField>
                  <VControl raw subcontrol>
            ...
            <div class="column is-5 p-0 ml-3 mr-3">
              <VField class="pt-3">
                <VControl>
                  <VInput type="text" v-model="input.norm" placeholder="Alasan Lain..." />
                </VControl>
              </VField>
            </div>
          </div>
        ...
        <div class="column pt-0">
          <p>Meskipun menurut dokter, pasien tersebut belum dijinkan pulang karena mash memerukan perawatan di rumah sakit
          </p>
          <p>Dan saya tidak akan menuntut pihak rumah sakit atau siapapun juga akibat dari keputusan saya pulang atas
            permintaan sendiri</p>
          <p>Demikianlah pernyataan ini saya buat dengan penuh kesadaran, dan bertanggung jawab atas resiko yang mungkin
            terjadi terhadap pasien sehubungan dengan pernyataan ini</p>
        </div>
