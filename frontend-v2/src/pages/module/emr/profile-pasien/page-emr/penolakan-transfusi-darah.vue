        ...
        <div class="column is-12">
            <VCard>
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12">
                        <Fieldset class="p-fieldsets" legend="PENOLAKAN TINDAKAN TRANSFUSI DARAH" :toggleable="true">
                            <div class="column is-12">
                                <h1 style="font-weight: bold;">Saya yang bertanda tangan dibawah ini :
                                </h1>
                                ...
                                <div class="column is-12 p-0">
                                    <div class="is-flex">
                                        ...
                                        <div class="column is-6" style=" margin-top: 0.5rem">
                                            <VField>
                                                <VDatePicker v-model="input.tanggalLahir" mode="dateTime"
                                ...
                                <div class="column is-12 p-0">
                                    <div class="is-flex">
                                        <div class="column is-2" style="margin-top:0.5rem">
                                            <h1 style="font-weight: bold;"> No. KTP/SIM/PASPOR : </h1>
                                        </div>
                                        <div class="column is-6">
                                            <VField>
                                                <VControl>
                                                    <VInput type="number" class="input" placeholder="No. KTP/SIM/PASPOR"
                                                        v-model="input.noktp" />
                                                </VControl>
                                ...
                                <div class="column is-12 p-0">
                                    <div class="is-flex">
                                        ...
                                        <div class="columns is-6" style=" margin-top: 1rem">
                                            <VField v-for="items in HubunganDenganPasien" :key="items.value" style="padding:0px;">
                                                <VControl raw subcontrol>
                                                    <VCheckbox v-model="input.hubunganDenganPasien" class="pt-1 pb-1 "
                                                        :true-value="items.label" :label="items.label" color="primary"
                                                        square />
                                                </VControl>
                                            </VField>
                                ...
                                <div class="column is-12">
                                    <div class="flex">
                                        <h1 style="font-weight: bold">
                                            Dengan ini menyatakan sesungguhnya, bahwa saya telah menerima informasi yang diberikan oleh Petugas sebagaimana di atas dan telah memahaminya. Untuk itu saya memberikan PENOLAKAN untuk diberikan TRANSFUSI DARAH terhadap.
                                        </h1>
                                    </div>
                                </div>
                                <div class="column is-12 p-0">
                                ...
                                <div class="column is-12">
                                    <h1 style="font-weight: bold">Saya memahami perlunya dan manfaat tindakan tersebut termasuk risiko dan komplikasi yang akan timbul bila tidak dilakukan tindakan tersebut. Saya akan bertanggung jawab secara penuh atas segala akibat yang mungkin timbul akibat penolakan dilakukan tindakan tersebut</h1>
                                </div>
                                <!-- <div class="column is-12">
                                    <h1 style="font-weight: bold">
                                        Alasan Penolakan
                ...
                <div class="column is-12 pb-1">
                 <div class="columns is-multiline" style="margin-top: 1rem;">
                     <div class="column is-12">
                       ...
                       <div class="column is-3">
                                <h1 style="font-weight: bold; margin-bottom: 1rem;"> Cirebon, Tanggal dan Jam</h1>
                                <VField>
                                    <VDatePicker v-model="input.tanggal" mode="dateTime" style="width: 100%" trim-weeks
                                        :max-date="new Date()">
                                        <template #default="{ inputValue, inputEvents }">
                        ...
                        <div class="column is-12">
                            <div class="columns is-12">
                                <div class="column is-3" style="text-align: center;">
                                    <TandaTangan :elemenID="'signature_3'" :width="'180'" :height="'180'"></TandaTangan>
                                    <VField class="mt-3">
                                        <h1 style="font-weight: bold;">Petugas :</h1>
                                        <VControl>
                                            <VInput type="text" v-model="input.namaSaksi3" placeholder="Petugas" />
                                        </VControl>
                                    </VField>
                                </div>
                                <div class="column is-3" style="text-align: center;">
                                    ...
                                    <VField class="mt-3">
                                        <h1 style="font-weight: bold;"> Saksi RS :</h1>
                                        <VControl>
                                ...
                                <div class="column is-3" style="text-align: center;">
                                    ...
                                    <VField class="mt-3">
                                        <h1 style="font-weight: bold;"> Saksi Pasien :</h1>
                                        <VControl>
...
import * as EMR from '../page-emr-plugins/penolakan-tindakan-transfusi-darah'
...
const HubunganDenganPasien: any = ref([
