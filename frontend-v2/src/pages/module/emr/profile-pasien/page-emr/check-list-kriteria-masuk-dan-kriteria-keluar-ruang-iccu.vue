...
:isLoading="isLoading" @simpan="simpan"
    ...
    <div class="columns is-12">
      <VCard>
        ...
        <div class="column is-12 p-0">
          <div class="is-flex">
            <div class="column is-2" style="margin-top:0.5rem">
              <span> Masuk ICCU Tanggal :</span>
            </div>
            <div class="column is-10">
              <VField>
                <VControl class="prime-auto">
                  <Calendar v-model="input.tanggalMICCU" selectionMode="single" :manualInput="true" class="w-100"
                    :showIcon="true" showTime hourFormat="24" :date-format="'yy-mm-dd'" :disabled="item.tgl2" />
                </VControl>
              </VField>
            </div>
        ...
        <div class="column is-12 p-0">
          <div class="is-flex">
            <div class="column is-2" style="margin-top:0.5rem">
              <span> Keluar ICCU Tanggal :</span>
            </div>
            <div class="column is-10">
              <VField>
                <VControl class="prime-auto">
                  <Calendar v-model="input.tanggalKICCU" selectionMode="single" :manualInput="true" class="w-100"
                    :showIcon="true" showTime hourFormat="24" :date-format="'yy-mm-dd'" :disabled="item.tgl2" />
                </VControl>
              </VField>
            </div>
        ...
        <table class="tbl-kmiccu">
          <thead>
            <tr>
              <th>KRITERIA MASUK ICCU</th>
              <th>KRITERIA KELUAR ICCU</th>
            </tr>
          </thead>
          <tbody>
            <td>
  ...
  import * as EMR from '../page-emr-plugins/checklist-kriteria-masuk-keluar-iccu'
  ...
  const COLLECTION: any = ref("CheckListKriteriaMasukdanKriteriaKeluarRuangICCU") //table mongodb
