<template>
  <FloatingButtonSave @click="simpanReal" :loading="isLoading" v-if="H.formatDate(props.registrasi.tglregistrasi, 'YYYY-MM-DD') >= H.formatDate(new Date(), 'YYYY-MM-DD') || props.registrasi.objectdepartemenfk!=18"/>
  <FloatingButtonPreview @click="simpan('')" :loading="isLoading" v-if="H.formatDate(props.registrasi.tglregistrasi, 'YYYY-MM-DD') >= H.formatDate(new Date(), 'YYYY-MM-DD') || props.registrasi.objectdepartemenfk!=18"/>
    ...
    <div class="column is-12">
      <VCard>
        <div class="columns is-multiline mt-3">
          ...
          <!-- <div class="column is-2">
            <VField label="Dokter Rawat Bersama" class="is-rounded-select_Z  is-autocomplete-select" v-slot="{ id }">
              <VControl icon="fa:users" fullwidth class="prime-auto ">
                <AutoComplete v-model="input.dokterRawatBersama" :suggestions="d_Dokter" @complete="fetchDokter($event)"
                  :optionLabel="'label'" :dropdown="true" :minLength="3" :appendTo="'body'"
                  :loadingIcon="'pi pi-spinner'" :field="'label'" placeholder="ketik untuk mencari..." />
              </VControl>
            </VField>
          ...
          <!-- <div class="column is-1 mt-5">
            <VControl>
              <VSwitchBlock v-model="isSbar" label="SBAR" color="warning" />
            </VControl>
          </div> -->
          <div class="column is-1 mt-5">
            <VControl>
            ...
            <table class="tg table-tg">
              <!-- <thead> -->
                <!-- <tr> -->
                  ...
                  <!-- <td class="tg-0lax text-center">Catatan Perkembangan Pasien Terintegrasi</td> -->
                  <!-- <td class="tg-0lax text-center">Intruksi PPA</td> -->
              ...
              <tbody v-for="(item, index) in dataSourcefiltered" :key="index">
                <tr v-if="item.flag != 'gizi'"
                    ...
                    <table class="tg">
                      <tr>
                        ...
                        <td v-if="item.flag == 'dokter'">
                          ...
                          <!-- <VIconButton circle icon="feather:copy" color="primary" raised bold outlined
                            @click="copyToClipboard(item.S)" style="float:right" class="ml-1 mt-2"
                            v-if="H.formatDate(props.registrasi.tglregistrasi, 'YYYY-MM-DD') >= H.formatDate(new Date(), 'YYYY-MM-DD') || props.registrasi.objectdepartemenfk!=18"
                            v-tooltip-prime.top="'Copy S'">
                          </VIconButton> -->
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td v-if="item.flag == 'dokter'">
                          ...
                          <!-- <VIconButton circle icon="feather:copy" color="primary" raised bold outlined
                            @click="copyToClipboard(item.O)" style="float:right" class="ml-1 mt-2"
                            v-if="H.formatDate(props.registrasi.tglregistrasi, 'YYYY-MM-DD') >= H.formatDate(new Date(), 'YYYY-MM-DD') || props.registrasi.objectdepartemenfk!=18"
                            v-tooltip-prime.top="'Copy O'">
                          </VIconButton> -->
                        </td>
                                ...
                                <table class="tg" style="width:100% !important">
                                    ...
                                    <tr>
                                      ...
                                      <!-- <th class="td-fkprj"
                                        ...
                                        <div class="column p-1">
                                          <VIconButton circle icon="feather:file-text" color="info" raised bold outlined
                                          ...
                                          <VIconButton circle icon="feather:copy" color="info" raised bold outlined
                                            @click="copyDOKTERA(item)" class="ml-1 mt-1"
                                  ...
                                  <tbody v-for="(itemsss, index3) in item.diagnosaDokter" v-if="item.diagnosaDokter.length === 0" :key="index3">
                                    <tr>
                                      ...
                                      <!-- <td class="tg-0lax">
                                        <div class="column p-1">
                                          <VIconButton circle icon="feather:file-text" color="warning" raised bold
                                            outlined @click="pasteItemDiagnosa(index, 'dokter')" class="ml-1"
                                            v-if="H.formatDate(props.registrasi.tglregistrasi, 'YYYY-MM-DD') >= H.formatDate(new Date(), 'YYYY-MM-DD') || props.registrasi.objectdepartemenfk!=18"
                                            v-tooltip-prime.top="'Terapkan Diagnosa '">
                                          </VIconButton>
                                          <VIconButton circle icon="feather:copy" color="primary" raised bold outlined
                                            @click="copyItemDiagnosa(itemsss, 'ICD10')" class="ml-1 mt-2"
                                ...
                                <table class="tg" width="100%">
                                  <thead>
                                    <tr>
                                      ...
                                      <!-- <th class="td-fkprj"
                                        style="vertical-align:inherit;text-align: center;font-size:9pt;" width="10%">
                                      </th> -->
                                    </tr>
                                  </thead>
                                  <tbody v-for="(itemsss, index3) in item.diagnosaDokter9" :key="index3">
                                    <tr>
                                      ...
                                      <!-- <td class="tg-0lax">
                                        <div class="column p-1">
                                          <VIconButton circle icon="feather:file-text" color="warning" raised bold
                                            outlined @click="pasteItemDiagnosa(index, 'perawat')" class="ml-1"
                                            v-if="H.formatDate(props.registrasi.tglregistrasi, 'YYYY-MM-DD') >= H.formatDate(new Date(), 'YYYY-MM-DD') || props.registrasi.objectdepartemenfk!=18"
                                            v-tooltip-prime.top="'Terapkan Diagnosa '">
                                          </VIconButton>
                                          <VIconButton circle icon="feather:copy" color="primary" raised bold outlined
                                            @click="copyItemDiagnosa9(itemsss, 'ICD9')" class="ml-1 mt-2"
                                            v-tooltip-prime.top="'Copy Diagnosa '">
                                          </VIconButton>
                                        </div>
                                      </td> -->
                      ...
                      <tr>
                        ...
                        <td v-if="item.flag == 'dokter'">
                          ...
                          <!-- <VIconButton circle icon="feather:copy" color="primary" raised bold outlined
                            @click="copyToClipboard(item.P)" style="float:right" class="ml-1 mt-2"
                            v-tooltip-prime.top="'Copy P'">
                          </VIconButton> -->
                        </td>
                              ...
                              <div class="columns is-multiline">
                                <div class="column is-4">
                                  <VButton type="button" rounded outlined icon="feather:save" :loading="isLoading"
                                    @click="simpanReal" color="success" v-tooltip-prime.top="'Simpan '">Simpan
                                  </VButton>
                                </div>
                                <div class="column is-4">
                                  <VButton type="button" rounded outlined color="warning" raised icon="feather:save" :loading="isLoading"
                                    @click="simpan('')"  v-tooltip-prime.top="'Preview '"> Preview
                                  </VButton>
                                </div>
                                <div class="column is-4">
                  ...
                  <!-- <td style="width:5%;vertical-align: text-top;">
                    <div class="columns is-multiline">
                      <tr>
                      ...
                      <tr>
                        <div class="column is-6">
                          <VIconButton circle icon="feather:copy" color="primary" raised bold @click="copy(item)"
                ...
                <tr v-if="item.flag == 'gizi'"
                  ...
                  <!-- <td style="width:15%">
                    <VField>
                      <VControl class="prime-auto">
                        <Calendar v-model="item.tgl" selectionMode="single" :manualInput="true" class="w-100" :showIcon="true"
                          showTime hourFormat="24" :date-format="'yy-mm-dd'" :disabled="item.tgl2" />
                      </VControl>
                    </VField>
                    <VField class="is-rounded-select_Z  is-autocomplete-select" v-slot="{ id }">
                      <VControl icon="fa:stethoscope" fullwidth class="prime-auto ">
                  ...
                  <td>
                    <table class="tg">
                      <tr>
                        ...
                        <!-- <td width="5%" style="width: 10%;font-weight: bold;vertical-align: middle;">
                                <VIconButton type="button" raised v-if="item.flag == 'dokter'" circle icon="fas fa-copy"
                                  v-tooltip-prime.bottom="'Terapkan'" @click="clearItem(item)" color="warning">
                                </VIconButton>
                                <VIconButton type="button" outlined raised v-if="item.flag == 'perawat'" circle
                                  icon="feather:copy" @click="copyToClipboard(item.S)" v-tooltip-prime.bottom="'Copy'"
                                  color="warning"></VIconButton>
                              </td> -->
                      </tr>
                      <tr>
                  ...
                  <!-- <td style="width:7%;vertical-align: text-top;">
                    <div class="columns is-multiline">
                      <div class="column is-6">
                        ...
                        <VIconButton type="button" raised circle icon="feather:save" :loading="isLoading" @click="simpanReal"
                          color="success" v-tooltip-prime.top="'Simpan '">
                        </VIconButton>
                      </div>
                      <div class="column is-6">
                        <VIconButton type="button" raised circle icon="fas fa-paste" @click="paste(item, index)"
...
const input: any = ref({
  details: [
    array_dokter.value, array_perawat.value, array_sbar.value, array_profesi.value, array_gizi.value]
})
      ...
      if (response.data.length) {
        ...
        for (let z = 0; z < response.data.length; z++) {
          ...
          element.diagnosaDokter9.push({
            ...
            diagnosaa: element2.namadiagnosatindakan && element2.kddiagnosatindakan ? { label: element2.kddiagnosatindakan + "-" + element2.namadiagnosatindakan, value: element2.kddiagnosatindakan } : '',
  ...
  await useApi().get(
    ...
    for (let x = 0; x < input.value.details.length; x++) {
      ...
      if (response.data.length) {
        ...
        element.diagnosaDokter.push({ no: element.diagnosaDokter.length + 1, jenisDiagnosa: { label: d_JenisDiagnosa.value[1].label, value: d_JenisDiagnosa.value[1].value } })
      } else {
        element.diagnosaDokter.push({
          no: 1,
...
const copy = (e) => {
  ...
  // console.log(dataSourcefiltered.value[0])
    // ICD 10
    const copiedDiagnosa = e.diagnosaDokter;
    copiedDiagnosa.forEach((element, index) => {
        const newDiagnosa = {
  ...
  // Jika ingin menyimpan data ke localStorage, bisa diaktifkan kembali
...
watch(
  ...
  (newKelompokUser, oldKelompokUser) => {
    ...
    if (newKelompokUser !== 'perawat' && newKelompokUser !== 'dokter' && newKelompokUser !== 'gizi' && !isProfesi.value) {
...
watch(
  ...
  (newValue, oldValue) => {
    ...
    if (newValue != oldValue) {
      if (!isProfesi.value && !isDokter.value && !isPerawat.value && !isGizi.value && !isSbar.value) {
        item.filter = ''
      }
    }
  }
