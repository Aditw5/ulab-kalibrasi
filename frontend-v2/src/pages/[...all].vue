    ...
    <div class="error-container">
      <div class="error-wrapper">
        <div class="error-inner has-text-centered">
          ...
          <img class="light-image" src="/@src/assets/illustrations/placeholders/error-2.svg" alt="" />
          <img class="dark-image" src="/@src/assets/illustrations/placeholders/error-2-dark.svg" alt="" />
