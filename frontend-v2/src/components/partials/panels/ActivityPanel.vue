            ...
            <ul>
              <li :class="[activeTab === 'team' && 'is-active']">
                <a tabindex="0" @keydown.space.prevent="activeTab = 'team'"
                  @click="activeTab = 'team'"><span>Logging</span></a>
              </li>
...
<!--
            <div class="team-card">
              <VAvatar size="small" color="primary" initials="JS" />
            ...
            <div class="team-card">
              ...
              <VAvatar size="small" color="info" initials="MW" />
              <div class="meta">
                <span>Melany W.</span>
                <span>
                  <i aria-hidden="true" class="iconify" data-icon="feather:map-pin"></i>
            ...
            <div class="team-card">
              <VAvatar size="small" color="danger" initials="EC" />
              <div class="meta">
                <span>Esteban C.</span>
                <span>
                  <i aria-hidden="true" class="iconify" data-icon="feather:map-pin"></i>
            ...
            <div class="team-card">
              <VAvatar size="small" color="warning" initials="TS" />
